...
#if((_D2_TMDS_SUPPORT == _ON) && (_TMDS_Z0_POWER_SAVING_OPTION == _ONLY_CLK_CHANNEL_CONNECTED_FOR_PS))
...
#if((_D3_TMDS_SUPPORT == _ON) && (_TMDS_Z0_POWER_SAVING_OPTION == _ONLY_CLK_CHANNEL_CONNECTED_FOR_PS))
...
#if((_D4_TMDS_SUPPORT == _ON) && (_TMDS_Z0_POWER_SAVING_OPTION == _ONLY_CLK_CHANNEL_CONNECTED_FOR_PS))
...
#if((_D5_TMDS_SUPPORT == _ON) && (_TMDS_Z0_POWER_SAVING_OPTION == _ONLY_CLK_CHANNEL_CONNECTED_FOR_PS))
