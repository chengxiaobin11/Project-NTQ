...
void ScalerPinshareRx0TypeCPinAssert(EnumTypeCPinCfgType enumTypeCPinCfgType, EnumTypeCOrientation enumTypeCOrientation)
{
    ...
    {
        // Pin AA6 Pinshare Config : GPI Mode
        ScalerSetBit(P10_02_PIN_SHARE_CTRL12, ~(_BIT2 | _BIT1 | _BIT0), 0x00);

        // Pin AA5 Pinshare Config : GPI Mode
        ScalerSetBit(P10_03_PIN_SHARE_CTRL13, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    }
    else
    {
        // Pin AA6 Pinshare Config : AUX_P Mode
        ScalerSetBit(P10_02_PIN_SHARE_CTRL12, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

        // Pin AA5 Pinshare Config : AUX_N Mode
        ScalerSetBit(P10_03_PIN_SHARE_CTRL13, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
    }
}
...
void ScalerPinshareRx1TypeCPinAssert(EnumTypeCPinCfgType enumTypeCPinCfgType, EnumTypeCOrientation enumTypeCOrientation)
{
    ...
    if(enumTypeCPinCfgType == _TYPE_C_PIN_ASSIGNMENT_NONE)
    {
        // Pin Y6 Pinshare Config : GPI Mode
        ScalerSetBit(P10_00_PIN_SHARE_CTRL10, ~(_BIT2 | _BIT1 | _BIT0), 0x00);

        // Pin Y5 Pinshare Config : GPI Mode
        ScalerSetBit(P10_01_PIN_SHARE_CTRL11, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    }
    else
    {
        // Pin Y6 Pinshare Config : AUX_P Mode
        ScalerSetBit(P10_00_PIN_SHARE_CTRL10, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

        // Pin Y5 Pinshare Config : AUX_N Mode
        ScalerSetBit(P10_01_PIN_SHARE_CTRL11, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
    }
}
...
void ScalerPinshareRxHpdPullDownSet(BYTE ucInputPort, bit bEnable)
{
    ...
    switch(ucInputPort)
    {
        ...
        case _D2_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_7B_PIN_PULLUP_CTRL01, ~(_BIT7 | _BIT6), _BIT7);
            }
            else
            {
                ScalerSetBit(P10_7B_PIN_PULLUP_CTRL01, ~(_BIT7 | _BIT6), 0x00);
            }
            break;
#endif
        ...
        case _D3_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_7B_PIN_PULLUP_CTRL01, ~(_BIT3 | _BIT2), _BIT3);
            }
            else
            {
                ScalerSetBit(P10_7B_PIN_PULLUP_CTRL01, ~(_BIT3 | _BIT2), 0x00);
            }
            break;
#endif
        ...
        case _D4_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_94_PIN_PULLUP_CTRL1A, ~(_BIT1 | _BIT0), _BIT1);
            }
            else
            {
                ScalerSetBit(P10_94_PIN_PULLUP_CTRL1A, ~(_BIT1 | _BIT0), 0x00);
            }
            break;
#endif
        ...
        case _D5_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_94_PIN_PULLUP_CTRL1A, ~(_BIT5 | _BIT4), _BIT5);
            }
            else
            {
                ScalerSetBit(P10_94_PIN_PULLUP_CTRL1A, ~(_BIT5 | _BIT4), 0x00);
            }
            break;
#endif
        default:
