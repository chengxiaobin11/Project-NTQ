...
void ScalerPLLSetDPLLRefPLL(DWORD ulFreq)
{
    ...
    if(ulCMUFreq == _DPTX_PHY_RATE_RBR)
    {
        ...
        // [3:0] CMU'S CP Current = 8.75uA
        ScalerSetBit(P55_0D_LVDS_COMMON_AB_CTRL13, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT6 | _BIT4 | _BIT2 | _BIT1));
    }
    else
    {
        ...
        // [7:5] PLL LPF serial resistor = 11k
        // [3:0] CMU'S CP Current = 16.25uA
        ScalerSetBit(P55_0D_LVDS_COMMON_AB_CTRL13, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | _BIT4 | _BIT3 | _BIT2));
    }
