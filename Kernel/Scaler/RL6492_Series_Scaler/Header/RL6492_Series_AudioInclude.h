...
#define CLR_AUDIO_D1_AUTO_LOAD_FREQ()                 {CLR_AUDIO_D0_AUTO_LOAD_FREQ();}
...
#define SET_DP_D1_AUDIO_CODING_TYPE_FORMAT(x)         {SET_DP_D0_AUDIO_CODING_TYPE_FORMAT(x);}

#define GET_DP_D1_AUDIO_CODING_TYPE_CHANGE()          (GET_DP_D0_AUDIO_CODING_TYPE_CHANGE())
#define SET_DP_D1_AUDIO_CODING_TYPE_CHANGE()          {SET_DP_D0_AUDIO_CODING_TYPE_CHANGE();}
#define CLR_DP_D1_AUDIO_CODING_TYPE_CHANGE()          {CLR_DP_D0_AUDIO_CODING_TYPE_CHANGE();}

#define GET_DP_D1_AUDIO_SAMPLING_FREQ_CHANGE()        (GET_DP_D0_AUDIO_SAMPLING_FREQ_CHANGE())
#define SET_DP_D1_AUDIO_SAMPLING_FREQ_CHANGE()        {SET_DP_D0_AUDIO_SAMPLING_FREQ_CHANGE();}
#define CLR_DP_D1_AUDIO_SAMPLING_FREQ_CHANGE()        {CLR_DP_D0_AUDIO_SAMPLING_FREQ_CHANGE();}
...
#define GET_AUDIO_DP_D1_CAPABILITY_SWITCH()           (GET_AUDIO_DP_D0_CAPABILITY_SWITCH())
#define SET_AUDIO_DP_D1_CAPABILITY_SWITCH()           {SET_AUDIO_DP_D0_CAPABILITY_SWITCH();}
#define CLR_AUDIO_DP_D1_CAPABILITY_SWITCH()           {CLR_AUDIO_DP_D0_CAPABILITY_SWITCH();}

#define GET_AUDIO_DP_D1_SUPPORT()                     (GET_AUDIO_DP_D0_SUPPORT())
#define SET_AUDIO_DP_D1_SUPPORT(x)                    {SET_AUDIO_DP_D0_SUPPORT(x);}
