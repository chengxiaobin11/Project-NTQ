...
void ScalerColorOCCPCMGammaInputGammaLoadTable(BYTE ucSelect);
#endif
//****************************************************************************
...
#if(_OCC_PCM_GAMMA_SUPPORT == _ON)
//--------------------------------------------------
// Description  : Adjust OCC PCM gamma
// Input Value  : 0-Gamma05, 1-Gamma06, ...
// Output Value : None
//--------------------------------------------------
void ScalerColorOCCPCMGammaInputGammaLoadTable(BYTE ucSelect)
{
    EnumOCCPCMGammaType enumOCCPCMGammaType = ucSelect;
    ScalerColorPCMInputGammaAdjust((BYTE *)ScalerColorOCCPCMGammaGetTableAddress(enumOCCPCMGammaType), ScalerColorOCCPCMGammaGetTableBank());
}
#endif
