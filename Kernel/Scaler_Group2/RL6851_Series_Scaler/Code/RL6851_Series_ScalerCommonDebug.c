...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonDebug.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _SCALER_OSD_DEBUG_CMD                     0x11
#define _OSD_GET_SRAM_ALL_BYTES_INITIAL_OP_CODE   0x01
...
//--------------------------------------------------
// Description  : Scaler Debug OSD Command
// Input Value  : NONE
// Output Value : None
//--------------------------------------------------
void ScalerDebugOSD(void)
{
    BYTE pucDdcciOutData[2] = {0};
    // OpCode
    pucDdcciOutData[0] = _SCALER_OSD_DEBUG_CMD;

    switch(g_pucDdcciData[1])
    {
        case _OSD_GET_SRAM_ALL_BYTES_INITIAL_OP_CODE:
            // add Get Sram all Bytes Inital Function
            ScalerOsdSramGetDataInit();
            pucDdcciOutData[1] = 0x00; // Replya Data 0: success, 1: Fail
            break;
        default:
            pucDdcciOutData[1] = 0xEE; // Replya Data 0: success, 1: Fail
            break;
    }
    ScalerDebugSendData(2, pucDdcciOutData);
}
