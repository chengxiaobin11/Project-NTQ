...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerVGIP.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#if(_HW_VGIP_V_START_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P0_16_M1_IPH_ACT_WID_H, ~_BIT6, ((HIBYTE(usIVstart) & 0x10) << 2));
#endif
    ScalerSetBit(P0_18_M1_IPV_ACT_STA_H, ~0x0F, (HIBYTE(usIVstart) & 0x0F));
    ScalerSetByte(P0_19_M1_IPV_ACT_STA_L, LOBYTE(usIVstart));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)
    // Set M2 V capture start
#if(_HW_VGIP_V_START_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P40_16_M2_IPH_ACT_WID_H, ~_BIT6, ((HIBYTE(usIVstart) & 0x10) << 2));
#endif

    ScalerSetBit(P40_18_M2_IPV_ACT_STA_H, ~0x0F, (HIBYTE(usIVstart) & 0x0F));
...
#if(_HW_VGIP_V_HEIGHT_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P0_16_M1_IPH_ACT_WID_H, ~_BIT7, ((HIBYTE(usIVheight) & 0x10) << 3));
#endif

    ScalerSetBit(P0_18_M1_IPV_ACT_STA_H, ~0xF0, ((HIBYTE(usIVheight) & 0x0F) << 4));
    ScalerSetByte(P0_1B_M1_IPV_ACT_LEN_L, LOBYTE(usIVheight));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)
    // Set M2 V capture height
#if(_HW_VGIP_V_HEIGHT_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P40_16_M2_IPH_ACT_WID_H, ~_BIT7, ((HIBYTE(usIVheight) & 0x10) << 3));
#endif

    ScalerSetBit(P40_18_M2_IPV_ACT_STA_H, ~0xF0, ((HIBYTE(usIVheight) & 0x0F) << 4));
...
#if(_HW_VGIP_V_DELAY_BIT_WIDTH == _10_BIT)
    ScalerSetBit(P0_16_M1_IPH_ACT_WID_H, ~_BIT5, ((HIBYTE(usIVSDelay) & _BIT1) << 4));
#endif

    ScalerSetBit(P0_1E_M1_VGIP_HV_DELAY, ~_BIT1, ((HIBYTE(usIVSDelay) & _BIT0) << 1));
    ScalerSetByte(P0_1C_M1_IVS_DELAY, LOBYTE(usIVSDelay));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)
    // Set M2 capture V delay
#if(_HW_VGIP_V_DELAY_BIT_WIDTH == _10_BIT)
    ScalerSetBit(P40_16_M2_IPH_ACT_WID_H, ~_BIT5, ((HIBYTE(usIVSDelay) & _BIT1) << 4));
#endif

    ScalerSetBit(P40_1E_M2_VGIP_HV_DELAY, ~_BIT1, ((HIBYTE(usIVSDelay) & _BIT0) << 1));
...
void ScalerVgipSetCaptureHStartPosition(WORD usIHstart)
{
    ...
    ScalerSetBit(P0_14_M1_IPH_ACT_STA_H, ~0x0F, (HIBYTE(usIHstart) & 0x0F));
    ScalerSetByte(P0_15_M1_IPH_ACT_STA_L, LOBYTE(usIHstart));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)
    // Set M2 H capture start
    ScalerSetBit(P40_14_M2_IPH_ACT_STA_H, ~0x0F, (HIBYTE(usIHstart) & 0x0F));
...
void ScalerVgipSetCaptureHWidth(WORD usIHwidth)
{
    ...
    // IHwidth[7:0]: P0_17[7:0]
#if(_HW_VGIP_H_WIDTH_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P0_16_M1_IPH_ACT_WID_H, ~_BIT0, ((HIBYTE(usIHwidth) & 0x10) >> 4));
#endif

    // Set M1 H capture width
    ScalerSetBit(P0_14_M1_IPH_ACT_STA_H, ~0xF0, ((HIBYTE(usIHwidth) & 0x0F) << 4));
    ScalerSetByte(P0_17_M1_IPH_ACT_WID_L, LOBYTE(usIHwidth));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)

#if(_HW_VGIP_H_WIDTH_BIT_WIDTH == _13_BIT)
    ScalerSetBit(P40_16_M2_IPH_ACT_WID_H, ~_BIT0, ((HIBYTE(usIHwidth) & 0x10) >> 4));
#endif

    // Set M2 H capture width
    ScalerSetBit(P40_14_M2_IPH_ACT_STA_H, ~0xF0, ((HIBYTE(usIHwidth) & 0x0F) << 4));
...
void ScalerVgipSetCaptureHDelay(WORD usIHSDelay)
{
    ...
    ScalerSetBit(P0_1E_M1_VGIP_HV_DELAY, ~(_BIT2 | _BIT0), (((HIBYTE(usIHSDelay) & _BIT1) << 1) | ((HIBYTE(usIHSDelay) & _BIT0))));
    ScalerSetByte(P0_1D_M1_IHS_DELAY, LOBYTE(usIHSDelay));

#if(_FORMAT_CONVERSION_SUPPORT == _ON)
    // Set M2 capture H delay
    ScalerSetBit(P40_1E_M2_VGIP_HV_DELAY, ~(_BIT2 | _BIT0), (((HIBYTE(usIHSDelay) & _BIT1) << 1) | ((HIBYTE(usIHSDelay) & _BIT0))));
