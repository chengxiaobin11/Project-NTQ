...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerCommonDPRx0Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
extern bit ScalerDpRx0InterlaceCheck(StructDpInfo *pstDpInfo);
extern bit ScalerDpRx0DeOnlyTimngCheck(StructDpInfo *pstDpInfo, DWORD ulFrameRate);
extern bit ScalerDpRx0DeOnlyJudge(StructDpInfo *pstDpInfo);
...
extern bit ScalerDpRx0InterlaceVtotalGetMSACheck(StructDpInfo *pstDpInfo);
...
extern bit ScalerDpRx0GetMsaTimingInfo(StructDpInfo *pstDpInfo);
