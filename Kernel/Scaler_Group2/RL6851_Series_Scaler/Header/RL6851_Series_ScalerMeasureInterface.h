...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerMeasureInterface.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//****************************************************************************
...
extern void ScalerMeasureDynamicColorInitial(WORD usDHStart, WORD usDHEnd, WORD usDVStart, WORD usDVEnd);
extern void ScalerMeasureDynamicColorSetAutoMeasure(BYTE ucColor);
extern bit ScalerMeasureDynamicColorGetResult(BYTE *pucColorAverageValue, bit bWait);
#endif
