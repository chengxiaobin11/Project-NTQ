...
// EDID Table
//--------------------------------------------------
#if((_D4_INPUT_PORT_TYPE == _D4_HDMI_PORT && _HDMI_24C02_SUPPORT) ||(_WRITE_EDID_TO_SYSTEM_EEPROM == _ON) || ((_D4_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE) && (_D4_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_CODE)))
