...
/********************************************************************************/
#if(_PANEL_TYPE == _BOE_MV315QUM_N70_EDP_UHD_60HZ)
//----------------------------------------------------------------------------------------------------
// ID Code      : 32_AUO_M270QAN010_EDP_UHD_60HZ.H
// Update Note  :
//----------------------------------------------------------------------------------------------------
#define _PANNEL_NAME                            _P_,_N_,_L_,_,_COLON__,_,_M_,_V_,_3_,_1_,_5_,_Q_,_U_,_M_,_N_,_7_,_0_
//////////////////
// General Info //
//////////////////
...
#define _PANEL_FREESYNC_MIN_FRAME_RATE          580
#endif
...
#define _PANEL_DV_TOTAL_MAX                 	2290
