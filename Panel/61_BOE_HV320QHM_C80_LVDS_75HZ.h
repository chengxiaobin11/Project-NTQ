...
#if(_PANEL_TYPE == _BOE_HV320QHM_C80_LVDS_75HZ)
//----------------------------------------------------------------------------------------------------
...
// General Info // 
//////////////////
#define _PANNEL_NAME                            _P__,_N__,_L__,__,_COLON__,__,_H__,_V__,_3__,_2__,_0__,_Q__,_H__,_M__,_C__,_8__,_0__
...
#define  _LVDS_CABLE_TYPE				_LVDS_CABLE_TYPE_1//		_LVDS_CABLE_TYPE_0
//--------------------------------------------------
...
#define _PANEL_MAX_FRAME_RATE                   900
...
#define _PANEL_DH_TOTAL                         3520                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     4092                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     2760                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         1506                // Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MAX                     2260                // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1478                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      292                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  360                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  224                 // Mininum Pixel Clock in MHz


#define _PANEL_POWER_ON_T1                      20                  // Panel Power On T1 (ms)
#define _PANEL_POWER_ON_T2                      20                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      400                 // Panel Power On T3 (ms)
