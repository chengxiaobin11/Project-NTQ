...
/********************************************************************************/
#if(_PANEL_TYPE == _LHCX_35_UHD_100HZ_EDP)
//----------------------------------------------------------------------------------------------------
// ID Code      : 32_AUO_M270QAN010_EDP_UHD_60HZ.H
// Update Note  :
//----------------------------------------------------------------------------------------------------
#define _PANNEL_NAME                            _P_,_A_,_N_,_E_,_L_,_,_COLON__,_,_L_,_M_,_3_,_4_,_0_,_U_,_W_,_1_,_S_,_S_,_A_,_3_
...
#define _PANEL_MIN_FRAME_RATE                 400//  300
...
#define _PANEL_DH_TOTAL_MAX               6640
#define _PANEL_DH_TOTAL_MIN                  3600

#define _PANEL_DV_START                         6
#define _PANEL_DV_HEIGHT                     1440
#define _PANEL_DV_END                   1446

#define _PANEL_DV_TOTAL                    1530
#define _PANEL_DV_TOTAL_MAX      3750
#define _PANEL_DV_TOTAL_MIN          1500

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK              367
#define _PANEL_PIXEL_CLOCK_MAX    540
