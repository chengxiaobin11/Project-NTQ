...
#define _D0_DP_TYPE_C_SMBUS_IIC                 _HW_IIC_PIN_AD28_AH27
...
#define bD0_USB_TYPEC_AUXP_CONNECT              (MCU_FE33_PORTA3_PIN_REG)   // Pin_AG29, PA.3
#define bD0_USB_TYPEC_AUXN_CONNECT              (MCU_FE34_PORTA4_PIN_REG)   // Pin_AH25, PA.4
#define bD0_CONNECT                             (MCU_FE08_PORT50_PIN_REG)   // Pin_AK4, P5.0
...
//-----------------------------------------------
// Macro of DP Type-C Alt Mode
//-----------------------------------------------
#define bD0_ALTMODE                             (MCU_FE08_PORT50_PIN_REG)   // Pin_AK4, P5.0
