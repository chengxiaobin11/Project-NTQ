...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__HKMRT2556E01__2H1DP__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
//20210901 xw移植创宏代码 吧2556E01 copy过来了
...
//#if(_IR_VIRTUAL)
//#define _156PIN_PIN_131                         (0 & 0x0F)//(8 & 0x0F) // Page 10-0x05[2:0]
//#else
// DDCSCL_VGA
//#define _156PIN_PIN_131                         (1 & 0x0F)//(8 & 0x0F) // Page 10-0x05[2:0]
// 0 ~ 8 (0: P1D5i<I>, 1: P1D5o<PP>, 2: P1D5o<OD>, 8: DDCSCLVGA)
//#endif

// DDCSDA_VGA
//#define _156PIN_PIN_132                         (0 & 0x0F)//(8 & 0x0F) // Page 10-0x06[2:0]
...
// DDCSDA_VGA
#define _156PIN_PIN_132                     (1 & 0x0F)//      (8 & 0x0F) // Page 10-0x06[2:0]
// 0 ~ 8 (0: P1D6i<I>, 1: P1D6o<PP>, 2: P1D6o<OD>, 8: DDCSDAVGA)
...
#define _156PIN_PIN_50_OFF_REGION                          (3 & 0x0F) // Page 10-0x1B[2:0]//1
...
// lamp_on
#define _156PIN_PIN_66                          (0 & 0x0F)//(2 & 0x0F) // Page 10-0x2F[2:0]
// 0 ~ 5 (0: P7D7i<I>, 1: P7D7o<PP>, 2: P7D7o<OD>, 3: PWM5<PP>, 4: PWM5<OD>,
//        5: TCON[11])

// 
#define _156PIN_PIN_67                          (2 & 0x0F)//(0 & 0x0F) // Page 10-0x30[2:0]
...
// PWM_R
#define _156PIN_PIN_78                          (0 & 0x0F)//(8 & 0x0F) // Page 10-0x3B[2:0]
...
#define  	_OSD_LED_ON       0//         1
#define  	_OSD_LED_OFF      1// 0

//#define   OSD_LED_CONTRL(x)          (MCU_FE1F_PORT77_PIN_REG = x)//_156PIN_PIN_66,   P7D7
//#define   GET_LED_STATUS()          (MCU_FE1F_PORT77_PIN_REG)


#define   OSD_LED_CONTRL(x)          (MCU_FE20_PORT80_PIN_REG = x)//_156PIN_PIN_67,   P8D0
#define   GET_LED_STATUS()          (MCU_FE20_PORT80_PIN_REG)


#if(_LED_EFFECT_TJMODE14==_ON)
    sbit bK1                                	= P1 ^ 5; //_156PIN_PIN_131 , P1D5  DDCSCL_VGA
#define OSD_LED_CONTRL_SCL(x)                       {\
                                                    bK1 = (x);\
                                                }
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE21_PORT81_PIN_REG)//(MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _156PIN_PIN_68, P8.1
...
#define  bD3_CONNECT                             (MCU_FE2B_PORT93_PIN_REG)  //_156PIN_PIN_78,P9D3
...
// Macro of LED On/Off
//--------------------------------------------------
#if(_DEF_LED_COLOR_OPPOSITE)	//指示灯颜色相反
#define bLED1                                   (MCU_FE26_PORT86_PIN_REG)
#define bLED2                                   (MCU_FE27_PORT87_PIN_REG)
#else
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																...
																if((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= ((KeyDefault[5]==2)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[5]==2)? AD_KEY1 : AD_KEY2) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _POWER_KEY_MASK;\
                                                                }\                                                                
                                                            }
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,__,_COLON__,__,_2__,_5__,_5__,_7__,_E__,_S__,__,_R__,_o__,_H__,_S__
#else
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,__,_COLON__,__,_2_,_5_,_5_,_6_,_Q_,_R_
#endif

#if(_DEF_HUIXIONG_GCCD)
#define _BURNIN_STR_IC_NAME                	 _B__,_o__,_a__,_r__,_d__,_COLON__,__,_H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_6__,_E__,_0__,_1__
#else
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_6__,_E__,_0__,_1__
#endif
...
#endif // End of #if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E01__2H1DP__LVDS)
