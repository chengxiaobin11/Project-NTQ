...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E12__1H1DP1T__LVDS)
...
#define _LVDS_PORT_EF_SWAP                      _DISABLE
#define _LVDS_PORT_GH_SWAP                      _DISABLE
#define _LVDS_PN_SWAP                            _DISABLE// _DISABLE//  
...
// LVDS Driving Config
//--------------------------------------------------
#define _LVDS_DRIV_CONTROL               _LVDS_DRIV_CONTROL_2_0//     _LVDS_DRIV_CONTROL_3_5
#define _LVDS_VCM_CONTROL               _LVDS_VCM_LOW//     _LVDS_VCM_NORMAL
...
#define _156PIN_PIN_66                          (1 & 0x0F)//(0 & 0x0F)//(1 & 0x0F)//(0 & 0x0F) // Page 10-0x2F[2:0]
// 0 ~ 5 (0: P7D7i<I>, 1: P7D7o<PP>, 2: P7D7o<OD>, 3: PWM5<PP>, 4: PWM5<OD>,
//        5: TCON[11])
...
#define   OSD_LED_CONTRL(x)          (MCU_FE1D_PORT75_PIN_REG = x)//_156PIN_PIN_65,   P7D5
#define   GET_LED_STATUS()          (MCU_FE1D_PORT75_PIN_REG)
...
#define bVCCKOFFPOWER                             (MCU_FE29_PORT91_PIN_REG)// _156PIN_PIN_66 //(MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE1F_PORT77_PIN_REG)// _156PIN_PIN_66
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE1F_PORT77_PIN_REG) // _156PIN_PIN_52, 7.7
...
//LIGHTTYPE 灯效IIC引脚
sbit bVGAIICSCL         				    	    =P1^5; // _156PIN_PIN_131, 
sbit bVGAIICSDA          					      	=P1^6; // _156PIN_PIN_132,
...
#define bD1_DP_PIN15_CONNECT                    (MCU_FE20_PORT80_PIN_REG) // 156PIN_PIN_67, P8.0
sbit bD1_DP_PIN16_CONNECT                     = P1 ^ 4; // 156PIN_PIN_119, P1.4
#define bD1_DP_PIN17_CONNECT                    (MCU_FE21_PORT81_PIN_REG) // 156PIN_PIN_68, P8.1
...
#define bD1_HPD                                 (MCU_FE23_PORT83_PIN_REG) // _156PIN_PIN_69, P8.3
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,_,_COLON__,_,_2_,_5_,_5_,_6_

#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_6__,_E__,_1__,_2__
