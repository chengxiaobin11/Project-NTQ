...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_SG_A_156PIN_1A1H_LVDS.h 
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__JY85QR_UPH_WS_R20_1__1H1DP__LVDS)
...
//#define _PORT_NAME_STR_D1				_STR_INDEX_HDMI
...
//#define _INPUTSOURCE_OSD_SETTING  _A0D1_INPUT//_A0VGA_D1DVI_D3HDMI 
//========================================
///////////////
#define _D1_TMDS_BR_SWAP                        _OFF		// dvi
#define _D1_TMDS_PN_SWAP                        _OFF	// dvi
...
// NC(AUDIO_HOUTR)
#define _156PIN_PIN_148                         (0 & 0x0F) // Page 10-0x13[2:0]
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE0A_PORT52_PIN_REG) // _PIN_52, P5.2
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE1A_PORT72_PIN_REG) // 156PIN_PIN_47, P6.2
...
#define bBACKLIGHTPOWER                         (MCU_FE1C_PORT74_PIN_REG) // 156PIN_PIN_49, P6.4
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ...
                                                        ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 3300);\
                                                    }\
                                                    else\
                                                    {\
...
#define bD0_CONNECT                            (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
#define bD1_CONNECT                             (bD1_HDMI_PIN11_CONNECT )
//sbit bD3_CONNECT                                = P1 ^ 0; // 156PIN_PIN_82, P1.0

#define PCB_A0_PIN()                            (bA0_CONNECT)
#define PCB_D0_PIN()                            (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(bD0_CONNECT)
#define PCB_D1_PIN()                            (bD1_CONNECT)
#define PCB_D3_PIN()                            (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//0//(bD3_CONNECT)
...
#define PCB_KEY_STATE(ucV0, ucV1,\
                      ucV2, ucV3, ucKeyState)   {\
                                                    if((0x00 <= (ucV1)) && ((ucV1) < 0x93))\
                                                    {\
                                                        (ucKeyState) |= _LEFT_KEY_MASK  ;\
                                                    }\
                                                    if((0xb0 <= (ucV1)) && ((ucV1) < 0xE8))\
                                                    {\
                                                        (ucKeyState) |= _EXIT_KEY_MASK  ;\
                                                    }\
                                                    if((0x00 <= (ucV2)) && ((ucV2) < 0xA0))\
                                                    {\
                                                        (ucKeyState) |=  _MENU_KEY_MASK ;\
                                                    }\
                                                    if((0xA0 <= (ucV2)) && ((ucV2) < 0xE8))\
                                                    {\
...
sbit bHeadphoneDetect                                    = P3^ 1; // 156PIN_PIN_136, P3.1
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_O_,_D_,_E_,_L_,_,_COLON__,_,_R_,_T_,_D_,_2_,_7_,_8_,_5_
#define _BURNIN_STR_IC_NAME                	  _R_,_T_,_D_,_2_,_7_,_8_,_5_


#endif // End of #if(_PCB_TYPE == _RL6432_SG_A_156PIN_1A1H_LVDS)
