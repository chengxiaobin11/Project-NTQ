...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__JY85TX_VPH_LS_R10_1__1A1H1DP__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__JY85TX_VPH_LS_R10_1__1A1H1DP__LVDS)
...
//#define _SG_MEMORY_TYPE                       _RTD2556T//_EMBEDDED_MEMORY_SIZE_NONE// _RTD2556T//_EMBEDDED_MEMORY_SIZE_NONE//  _RTD2556T//  _RTD2785T//_RTD2556T
...
//#define _PORT_NAME_STR_A0						_STR_INDEX_VGA
//--------------------------------------------------
// D0 Input Port
//--------------------------------------------------
#define _D0_INPUT_PORT_TYPE                     _D0_NO_PORT
#define _D0_DDC_CHANNEL_SEL                   _NO_DDC // _DDC0
#define _D0_EMBEDDED_DDCRAM_MAX_SIZE               _EDID_SIZE_NONE// _EDID_SIZE_256//_EDID_SIZE_NONE
...
//#define _PORT_NAME_STR_D1						_STR_INDEX_DP
...
//#define _INPUTSOURCE_OSD_SETTING  _A0D1D3_INPUT//_A0VGA_D1DVI_D3HDMI 
//========================================
///////////////
#define _D1_TMDS_BR_SWAP                        _OFF// HDMI
#define _D1_TMDS_PN_SWAP                        _OFF// HDMI
...
#define _BACKLIGHT_PWM_INVERSE                  _OFF
#define _AUDIO_VOLUMN_PWM						_PWM5
#define _AUDIO_VOLUMN_PWM_INVERSE				_OFF
...
// line_inl
#define _156PIN_PIN_151                         (3 & 0x0F) // Page 10-0x14[2:0]
// 0 ~ 4 (0: P4D4i<I>, 1: P4D4o<PP>, 2: P4D4o<OD>, 3: line_inl, 4: ws)

// line_inr
#define _156PIN_PIN_152                         (3 & 0x0F) // Page 10-0x15[2:0]
...
// 
#define _156PIN_PIN_51_OFF_REGION                           (3 & 0x0F) // Page 10-0x19[2:0]
...
// ADJBACKLITE
#define _156PIN_PIN_54_OFF_REGION                           (4 & 0x0F) // Page 10-0x25[2:0]
...
// AUDO_VOLUME
#define _156PIN_PIN_66                          (3 & 0x0F) // Page 10-0x2F[2:0]
// 0 ~ 5 (0: P7D7i<I>, 1: P7D7o<PP>, 2: P7D7o<OD>, 3: PWM5<PP>, 4: PWM5<OD>,
//        5: TCON[11])

// AUDIO PWM
#define _156PIN_PIN_67                          (0 & 0x0F) // Page 10-0x30[2:0]
...
//-----------------------------------------------
#define bVCCKOFFPOWER                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // (MCU_FE20_PORT80_PIN_REG) // 156PIN_PIN_67, P8.0
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE0A_PORT52_PIN_REG) // _156PIN_PIN_52, P5.2
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE0B_PORT53_PIN_REG) // _156PIN_PIN_50, P5.3
...
sbit bD0_DP_PIN16_CONNECT                       = P1 ^ 3; // 156PIN_PIN_118, P1.3
#define bD0_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_71, P8.4
sbit bD1_HDMI_PIN11_CONNECT                     = P1 ^ 4; // 156PIN_PIN_119, P1.4
#define bD1_DP_PIN15_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_74, P8.7
#define bD1_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_73, P8.6

sbit bA0_CONNECT                                = P1 ^ 7;  // 156PIN_PIN_133, P1.7
#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
#define bD1_CONNECT                             (bD1_HDMI_PIN11_CONNECT)
sbit bD3_CONNECT                             	= P1 ^ 0; // 156PIN_PIN_82, P1.0

#define PCB_A0_PIN()                            (bA0_CONNECT)
#define PCB_D0_PIN()                            (bD0_CONNECT)
#define PCB_D1_PIN()                            (bD1_CONNECT)
#define PCB_D3_PIN()                            (_FALSE)//(bD3_CONNECT)//

//-----------------------------------------------
// Macro of DP Source Power
//-----------------------------------------------
#define GET_PCB_D0_DP_SOURCE_POWER()            (bD0_DP_PIN17_CONNECT)
#define GET_PCB_D1_DP_SOURCE_POWER()            (bD0_DP_PIN17_CONNECT)
#define GET_PCB_D3_DP_SOURCE_POWER()            (bD1_DP_PIN17_CONNECT)
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_70, P8.2
...
#define bLED1                                   (MCU_FE24_PORT84_PIN_REG) // 156PIN_PIN_71, P8.4
#define bLED2                                   (MCU_FE25_PORT85_PIN_REG) // 156PIN_PIN_72, P8.5
...
#ifndef _COMMON_KEY
#define _COMMON_KEY		_OFF
#endif

sbit bPOWER_KEY                              	= P3 ^ 1; // _156PIN_PIN_76, P9.1




#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0x18 <= (ucV1)) && ((ucV1) < 0x38))\
                                                                {\
                                                                    (ucKeyState) |=_EXIT_KEY_MASK   ;\
                                                                }\
                                                                if((0xA8 <= (ucV1)) && ((ucV1) < 0xE8))\
                                                                {\
                                                                    (ucKeyState) |= _MENU_KEY_MASK  ;\
                                                                }\
                                                                if((0x60<= (ucV2)) && ((ucV2) < 0xA0))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK   ;\
                                                                }\
                                                                if((0x18 <= (ucV2)) && ((ucV2) < 0x38))\
                                                                {\
...
sbit bHeadphoneDetect                                    = P3 ^ 0; // 156PIN_PIN_136, P3.1
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_O_,_D_,_E_,_L_,_,_COLON_,_,_J_,_Y_,_8_,_5_,_T_,_X_
#define _BURNIN_STR_IC_NAME                	  _J_,_Y_,_8_,_5_,_T_,_X_


#endif // End of #if(_PCB_TYPE == _RL6432_SG_A_SG26TX_156PIN_1A1P1H_LVDS)
