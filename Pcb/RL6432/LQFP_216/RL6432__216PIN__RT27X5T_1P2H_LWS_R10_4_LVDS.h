...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__216PIN__RT27X5T_1P2H_LWS_R10_4_LVDS)
...
// D3 Input Port
//--------------------------------------------------
#define _D3_INPUT_PORT_TYPE                     _D3_HDMI_PORT//_D3_MHL_PORT
#define _D3_DDC_CHANNEL_SEL                     _DDC3
#define _D3_EMBEDDED_DDCRAM_MAX_SIZE                _EDID_SIZE_256//_EDID_SIZE_NONE
...
// ADJBACKLITE
#define _PIN_178_OFF_REGION                                (4 & 0x0F) // Page 10-0x25[2:0]
...
//--------------------------------------------------
#define bPANELPOWER                           (MCU_FE0C_PORT54_PIN_REG) // Pin_170, P6.2
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE0D_PORT55_PIN_REG) // Pin_172, P6.4
...
#define bLED1                                      (MCU_FE01_PORT41_PIN_REG ) // Pin_90 Green
#define bLED2                                      (MCU_FE00_PORT40_PIN_REG) // Pin_89 RED
...
//-----------------------------------------------
#define bHeadphoneDetect                        (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_90  P4.1
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_7_,_8_,_5_,_U_,_T_
#define _BURNIN_STR_IC_NAME                	  _R_,_T_,_D_,_2_,_7_,_8_,_5_,_U_,_T_
