...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__216PIN__RTD2785_VHD_LS_R20_1__1A1H1DVI__LVDS)
...
#define bLED1                                   (MCU_FE48_PORTD0_PIN_REG)	// Pin_97, PC.7  
#define bLED2                                   (MCU_FE47_PORTC7_PIN_REG)	// Pin_98, PD.0
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,_,_COLON__,_,_R_,_T_,_D_,_2_,_7_,_8_,_5_,_T_
