...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6432_SG_A_216PIN_2H1DP_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__216PIN__SG2785T_UPH_LWS_R20_1__1H1P1U__LVDS)
...
// A0 Input Port
//--------------------------------------------------
#define _A0_INPUT_PORT_TYPE                    	_A0_NO_PORT// _A0_VGA_PORT
...
//#define _PORT_NAME_STR_D2						_STR_INDEX_HDMI1

//--------------------------------------------------
// D3 Input Port
//--------------------------------------------------
#define _D3_INPUT_PORT_TYPE                     _D3_NO_PORT//_D3_MHL_PORT
#define _D3_DDC_CHANNEL_SEL                     _DDC3
#define _D3_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_NONE//_EDID_SIZE_NONE
...
//--------------------------------------------------
#define _INPUT_PORT_SEARCH_PRI_0                _D1_INPUT_PORT//_A0_INPUT_PORT
#define _INPUT_PORT_SEARCH_PRI_1                _D2_INPUT_PORT//_D0_INPUT_PORT
//#define _INPUT_PORT_SEARCH_PRI_2                _D3_INPUT_PORT//_D1_INPUT_PORT
...
//#define _INPUTSOURCE_OSD_SETTING    _D1D2D3_INPUT//_D1DP_D2HDMI_D3HDMI   
/*#define _VGA_1                                      _NO_INPUT_PORT
#define _DVI_1                                      _NO_INPUT_PORT
#define _DVI_2                                      _NO_INPUT_PORT
#define _DP_1                                       _D1_DP_PORT
#define _DP_2                                       _NO_INPUT_PORT
#define _HDMI_1                                     _D2_HDMI_PORT
...
//#ifdef K1B
//#if((_MODEL_TYPE>>4 == K1B)||(_MODEL_TYPE>>4 == K1C))
...
//        5: test4b_out2 , 6:test4b_out3)
#if 1//(_CUSTOMER_TYPE==_INNO_CN_CUSTOMER)
// LED_R===INNO
...
// 
#define _PIN_170_OFF_REGION                                  (0 & 0x0F) // Page 10-0x22[2:0]
...
// 
#define _PIN_172_OFF_REGION                                  (0& 0x0F) // Page 10-0x24[2:0]
...
// AUdio Volume
#define _PIN_97                                 (4 & 0x0F) // Page 10-0x5B[2:0]
...
// GPIO Power Macro //
//////////////////////
sbit bUSB_ENABLE                                = P1 ^ 6;  // 216PIN_PIN_68, P1.6
...
sbit b12V_ENABLE                                = P1 ^ 7;  // 216PIN_PIN_68, P1.7

#define PCB_12V_ENABLE(x)                      {\
                                                    b12V_ENABLE = (x);\
                                                }
...
#define   OSD_LED_CONTRL(x)          (MCU_FE0E_PORT56_PIN_REG = x)
#define   GET_LED_STATUS()          (MCU_FE0E_PORT56_PIN_REG)
...
#define PCB_GPIO_SETTING_POWER_AC_ON()          {\
													PCB_12V_ENABLE(1);\
													PCB_VCCK_OFF_POWER(_DDR_POWER_ON);\
													PCB_DDR_POWER(_VCCK_OFF_POWER_ON);\
                                                }
...
#define PCB_GPIO_SETTING_POWER_SAVING()         {\
													PCB_12V_ENABLE(0);\
													PCB_VCCK_OFF_POWER(_DDR_POWER_OFF);\
													PCB_DDR_POWER(_VCCK_OFF_POWER_OFF);\
                                                }
...
//-----------------------------------------------
#define bVCCKOFFPOWER                           (MCU_FE1D_PORT75_PIN_REG) // Pin_195, P7.5
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE10_PORT60_PIN_REG) // _PIN_197, P9.0
...
//--------------------------------------------------
#define bPANELPOWER                           (MCU_FE0C_PORT54_PIN_REG) // Pin_164
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE0D_PORT55_PIN_REG) // Pin_165
...
//-----------------------------------------------
sbit bD1_CONNECT                       = P1 ^ 4;                 // Pin_54, P1.4  DP
#define bD2_CONNECT                    (MCU_FE30_PORTA0_PIN_REG) // Pin_216    HDMI
sbit bD3_CONNECT                       = P1 ^ 0;                 // Pin_1  HDMI
...
#define GET_PCB_D1_DP_SOURCE_POWER()            (bD1_CONNECT)
...
#define bD1_HPD                                    (MCU_FE23_PORT83_PIN_REG) // Pin_200, 
//sbit bD2_HPD                                    = P1 ^ 2; // Pin_15, P1.2
#define bD2_HPD                                (P1_2)
sbit bD3_HPD                                    = P1 ^ 1; // Pin_15, P1.2
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 20000);\
 ScalerMcuPwmAdjustFrequency(_AUDIO_VOLUMN_PWM, 20000);\
                                                }
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                      (MCU_FE24_PORT84_PIN_REG ) // Pin_90 Green
#define bLED2                                      (MCU_FE25_PORT85_PIN_REG) // Pin_89 RED
...
#define      bPOWER_KEY                                (MCU_FE29_PORT91_PIN_REG)
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE48_PORTD0_PIN_REG)  //Pin_98
...
#define _MAIN_PAGE_MODEL_NAME                _M_,_o__,_d__,_e__,_l__,_,_COLON_,_,_2_,_7_,_8_,_5_,_T_
#define _BURNIN_STR_IC_NAME                	  _R_,_T_,_D_,_2_,_7_,_7_,_5_,_T_,_Z_


#endif // End of #if(_PCB_TYPE == _RL6432_SG_A_216PIN_2H1DP_LVDS)
