...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449_SG_2DP2HDMI_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__SG95T_UPH_LS_R10_1__1DP2H__eDPVB1)
...
// KP_LED1
#define _PIN_184                                (2 & 0x0F) // Page 10-0x34[2:0]
...
#define PCB_GPIO_OFF_REGION_INITIAL_SETTING()   {\
								                            PCB_USB_POWER_PIN(_USB_CONTROL_ON);\
                                                }
...
#define PCB_GPIO_SETTING_POWER_DOWN()           {\												
													PCB_USB_POWER_PIN(_USB_CONTROL_OFF);\
                                                }
...
/////////////////////
//--------------------------------------------------
// Macro of USB Power Up/Down
//--------------------------------------------------
#define bUSBPOWER                         (MCU_FE30_PORTA0_PIN_REG) // Pin_196, P9.2

#define _USB_CONTROL_ON                      1
#define _USB_CONTROL_OFF                  0

#define PCB_USB_POWER_PIN(x)              {\
                                                    bUSBPOWER = (x);\
                                                }
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (P1_7) // Pin_70, P1.7
#define bD0_DP_PIN16_CONNECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// (P1_6) // Pin_69, P1.6
#define bD0_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_5) // Pin_68, P1.5
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 960);\
                                                }
...
#define bLED1                                   (P3_5) // Pin_92, P3.5
#define bLED2                                   (P3_6) // Pin_91, P3.6
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE1C_PORT74_PIN_REG) // _PIN_161 P7.4 
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_O_,_D_,_E_,_L_,_,_COLON_,_,_S_,_G_,_9_,_5_,_T_,_,_U_,_2_,_H_,_P_
#define _BURNIN_STR_IC_NAME                	  _S_,_G_,_9_,_5_,_T_,_,_U_,_2_,_H_,_P_

#endif // End of #if(_PCB_TYPE == _RL6449_SG_2DP2HDMI_DPTX_eDP)
