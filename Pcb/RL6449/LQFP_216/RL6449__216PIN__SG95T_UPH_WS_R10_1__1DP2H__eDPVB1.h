...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__SG95T_UPH_WS_R10_1__1DP2H__eDPVB1)
...
#define   OSD_LED_CONTRL(x)          (MCU_FE21_PORT81_PIN_REG = x)
#define   GET_LED_STATUS()          (MCU_FE21_PORT81_PIN_REG)
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE1B_PORT73_PIN_REG ) // _PIN_161 P7.4 
