...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449__216PIN__YY95UTUT2H_R10_1_1DP2H_TYPEC_USB_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__YY95UTUT2H_R10_1_1DP2H_TYPEC_USB_DPTX_eDP)
...
//--------------------------------------------------
#define _D1_DP_PCB_LANE0_MAPPING                _DP_SCALER_LANE1
#define _D1_DP_PCB_LANE1_MAPPING                _DP_SCALER_LANE3
...
// Series Pin Share //
//////////////////////
#include "RL6449__216PIN__YY95UTUT2H_R10_1_1DP2H_TYPEC_USB_DPTX_eDP_PINSHARE.h"



#define   bDDC_AUDIO_EN                             (MCU_FE2F_PORT97_PIN_REG) // _PIN_201, P9.7
#define   Reset_pin                                     (MCU_FE2E_PORT96_PIN_REG) // _PIN_200, P6.4




 sbit bDDC_AUDIO_SDA                       = P1 ^ 3; // _PIN_66, P1.3
 sbit bDDC_AUDIO_SCL                       = P1 ^ 2; // _PIN_65, P1.2


#define    SET_RESET()         (Reset_pin = 1)
#define    CLR_RESET()         (Reset_pin = 0)


#define SDA_H                             (bDDC_AUDIO_SDA = _TRUE 	)
#define SDA_L                             (bDDC_AUDIO_SDA = _FALSE )
#define READ_SDA()						  (bDDC_AUDIO_SDA 	    )

#define SCL_H                             (bDDC_AUDIO_SCL = _TRUE 	)
#define SCL_L                             (bDDC_AUDIO_SCL = _FALSE )

#define  ACK_OK									1
#define  ACK_NG									0


#define  SET_SDA_IN()						ScalerSetByte(0x1003, (BYTE)0) // Page 10-03[2:0], Pin_66

#define  SET_SDA_OUT()					    ScalerSetByte(0x1003, (BYTE)1)// Page 10-03[2:0], Pin_66
...
/////////////////////
//usb_en
//#define bUSBPOWER                           (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
sbit bUSBPOWER                       = P1 ^ 5; // _PIN_68, P1.5

#define _USB_POWER_ON                      0
#define _USB_POWER_OFF                1
...
//usb_hub_en
sbit bUSB_HUB_EN                     = P1 ^ 4; // PIN_67, P1.4

#define _USB_HUB_ON                      0
#define _USB_HUB_OFF                1
...
//-----------------------------------------------
#define bVCCKOFFPOWER                           (MCU_FE25_PORT85_PIN_REG) // Pin_185, P8.5
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE24_PORT84_PIN_REG) //  Pin_184, P8.4
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE22_PORT82_PIN_REG) // Pin_180, P8.2
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE2A_PORT92_PIN_REG) // Pin_196, P9.2
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_70, P1.7
#define bD0_DP_PIN16_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_69, P1.6
#define bD0_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_68, P1.5
...
#define bA0_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // Pin_67, P1.4
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_96, P4.1
...
#define bLED1                               (P3_6)//  //Pin_92, P3.6//green
#define bLED2                                 (P3_5) //Pin_91, P3.5//yellow
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
  ...
  sbit bHeadphoneDetect							= P1 ^ 7;//Pin70
  sbit bHeadphoneDetect1                         = P1 ^ 6;//Pin69
  #define HeadPhone_1
...
#define _MAIN_PAGE_MODEL_NAME                   _M_,_o__,_d__,_e__,_l__,_,_COLON_,_,_R_,_T_,_D_,_2_,_7_,_9_,_5_,_U_,_T_
#define _BURNIN_STR_IC_NAME                	    _R_,_T_,_D_,_2_,_7_,_9_,_5_,_U_,_T_


#endif // End of #if(_PCB_TYPE == _RL6449__216PIN__YY95UTUT2H_R10_1_1DP2H_TYPEC_USB_DPTX_eDP)
///////////////////
