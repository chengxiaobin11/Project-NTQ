...
//-------------------------------------------------
#if(((0x2000 <= Project_ID) && (Project_ID <= 0x2FFF)) || (Project_ID == ID_COMMON))
...
//--------------------------------------------------
#define _OOR_H_FREQ_UPPER_BOUND                                 2500 // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 2100 // Unit in 0.1 HZ
...
#define _FAIL_SAVE_H_FREQ_UPPER_BOUND                           2500 // Unit in 0.1 kHZ
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           110  // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           2100 // Unit in 0.1 HZ
...
#define _INPUTCLOCK_RANG_HDMI                                   5000 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DP                                     5000 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_USBC                                   5000 // Unit in 0.1 MHz
...
#define _DIGITAL_VOLUME_MAX                                     0x1784                      // MAX: 0x3FFF
...
//--------------------------------------------------
#if 1//(_IR_VIRTUAL)
#define _IR_SUPPORT                                             _IR_HW_SUPPORT
#else
