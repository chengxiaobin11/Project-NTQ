...
// Pcb Option
//--------------------------------------------------
//#define _PCB_TYPE                                               _RL6449__216PIN__JY27X5T_2P2H_WS_R10_3__2DP2H__eDPVB1

//--------------------------------------------------
// Panel Option
//--------------------------------------------------
//#define _PANEL_TYPE                                             _LG_LM270WR2_EDP_UHD_60HZ
...
#define _CAPABILITIES_STRING_VGA                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(0B 0C 0E 10 12 14(05 06 08 0B) 16 18 1A 1E 1F 20 30 3E 60(03 0F) 87 AC AE B2 B6 C6 C8 CC(01 02 03 06 07 09 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DVI                                "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(0B 0C 10 12 14(05 06 08 0B) 16 18 1A 60(03 0F) 87 AC AE B2 B6 C6 C8 CC(01 02 03 06 07 09 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(0B 0C 10 12 14(05 06 08 0B) 16 18 1A 60(03 0F) 87 AC AE B2 B6 C6 C8 CC(01 02 03 06 07 09 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(0B 0C 10 12 14(05 06 08 0B) 16 18 1A 60(03 0F) 87 AC AE B2 B6 C6 C8 CC(01 02 03 06 07 09 0A 0D) D6(01 04 05) DF FD FF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#define _EMBEDDED_MEMORY_SIZE_CONFIG                            _16M_16BIT_DDR2_1PC
...
#define _WRITE_EDID_TO_SYSTEM_EEPROM                            _ON //_OFF
...
#define _HDCP_2_2_KEY_LOCATION                                  _TABLE_LOCATION_FLASH// _TABLE_LOCATION_CODE
...
#define _RX_HDCP_2_2_KEY_FLASH_BANK                            10// 15
...
#define _TX_HDCP_2_2_KEY_FLASH_BANK                             10//15
...
#define _SOURCE_DEFAULT_SEARCH_TIME_HDMI                        SEC(10)
...
#define _INPUTCLOCK_RANG_DP                                     7000 // Unit in 0.1 MHz
...
#define _MHL2_PP_MODE_SUPPORT                                   _OFF
...
#if(Project_ID == ID_TJZG_TMDTMD2822_HK2775E01_2P2H_UHD60HZ_20231217|| Project_ID == ID_TJZG_HK2775E05_M270KCAD8B_EDP4LANHBR2_MD2769_QHD180HZ_20240313|| Project_ID == ID_TJZG_HK2775E01_SN270ES011_EDP4LANHBR2_F2761QK_QHD180HZ_20240416|| Project_ID == ID_TJZG_HK2775E01_SN270ES011_EDP4LANHBR2_QHD180HZ_20240426||ID_TJZG_HK2775E01_SN270ES011_EDP4LANHBR2_QHD180HZ_G27L61QK_20240509||ID_TJZG_HK2775E05_SN245ES01_2_EDP4LANHBR2_MD2569_QHD180HZ_20240528)
#define _DIGITAL_VOLUME_MAX                                     0x1308                      // MAX: 0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
#else
#define _DIGITAL_VOLUME_MAX                                     0x2FFF                      // MAX: 0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
#endif
...
#define _PANEL_DPTX_MSA_TIMING_PAR_IGNORE_EN    				_OFF
