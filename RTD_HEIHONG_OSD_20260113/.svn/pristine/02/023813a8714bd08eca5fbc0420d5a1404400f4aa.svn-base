...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_SG_A_216PIN_1DVI1H1DP_DPTX_LVDS_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__216PIN__SG2785T_PHD_LS_R10_2__1D1H1P__LVDS)
...
// D3 Input Port
//--------------------------------------------------
#define _D3_INPUT_PORT_TYPE                     _D3_DUAL_DVI_PORT
#define _D3_DDC_CHANNEL_SEL                     _DDC3
#define _EMBEDDED_DDCRAM_D3_MAX_SIZE                 _EDID_SIZE_128
...
//sbit bD0_DP_PIN16_CONNECT                       = P1 ^ 3;                  // Pin_53, P1.3
...
sbit bD1_DP_PIN16_CONNECT                       = P1 ^ 4;                 // Pin_54, P1.4
...
sbit bD0_CONNECT                          =P1^3;//(((bit)bD1_DP_PIN15_CONNECT == _TRUE) && ((bit)bD1_DP_PIN16_CONNECT == _TRUE) && ((bit)bD1_DP_PIN17_CONNECT == _FALSE))
sbit bD1_CONNECT                          =P1^4;// (MCU_FE30_PORTA0_PIN_REG) // PIN_216, PA.0
sbit bD3_CONNECT                          = P1 ^ 0;  // PIN_1, P1.0
...
#define bD0_HPD                                 (MCU_FE22_PORT82_PIN_REG) // Pin_200, P8.3
sbit bD1_HPD                                    = P1 ^ 2; // Pin_15, P1.2
sbit bD3_HPD                                    = P1 ^ 1; // Pin_3, P1.1
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_FE47_PORTC7_PIN_REG)	// Pin_97, PC.7  Amber
#define bLED2                                   (MCU_FE48_PORTD0_PIN_REG)	// Pin_98, PD.0  Green 
...
#endif // End of #if(_PCB_TYPE == _RL6432_SG_A_216PIN_1DVI1H1DP_DPTX_LVDS_eDP)
