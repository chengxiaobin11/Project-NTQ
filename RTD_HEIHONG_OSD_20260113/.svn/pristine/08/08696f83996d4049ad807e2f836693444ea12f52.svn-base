...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449__216PIN__YY95UTUT2H_R10_1_1DP2H_TYPEC_USB_DPTX_eDP_PINSHARE.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// WS
#define _PIN_113_OFF_REGION                     (4 & 0x0F) // Page 10-0x15[2:0]
// 0 ~ 4 (0: P4D5i<I>, 1: P4D5o<PP>, 2: P4D5o<OD>, 3: line_inl, 4: ws)

//SCK
#define _PIN_114_OFF_REGION                     (4 & 0x0F) // Page 10-0x16[2:0]
// 0 ~ 4 (0: P4D6i<I>, 1: P4D6o<PP>, 2: P4D6o<OD>, 3: line_inr, 4: sck)

// MCK
#define _PIN_115_OFF_REGION                     (4 & 0x0F) // Page 10-0x17[2:0]
// 0 ~ 4 (0: P4D7i<I>, 1: P4D7o<PP>, 2: P4D7o<OD>, 3: audio_ref, 4: mck)

// SDI
#define _PIN_116_OFF_REGION                     (4 & 0x0F) // Page 10-0x18[2:0]
