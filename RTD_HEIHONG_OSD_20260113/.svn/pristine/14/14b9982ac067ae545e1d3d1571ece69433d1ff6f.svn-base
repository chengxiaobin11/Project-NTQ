...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_VGATopInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
// HS delay Time
//--------------------------------------------------
#define _PHASE_DELAY_TIME_VALUE_SHORT_PATH          (-287) // -287 = 64 * -4.48 (Unit: ns)
#define _PHASE_DELAY_TIME_VALUE_LONG_PATH           (268) // 268 = 64 * 4.18 (Unit: ns)
#define _PHASE_DELAY_HALF_PERIOD_SHIFT              0
