...
#if(_PANEL_TYPE == _PANDA_LC238LF1F_LVDS)
//----------------------------------------------------------------------------------------------------
// ID Code      : 99_PANDA_LC238LF1F_LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(Project_ID == ID_TJ_2556E01_SN270CS03_1_LOGO_FUEGO_27TZ180FIG2_FHD165_20240104)
#define _PANNEL_NAME                        _P__,_a__,_n__,_e__,_l__,__,_COLON__,__,_M__,_E__,_2__,_7__,_0__,_F__,_H__,_B__,_SLINE__,_N__,_F__,_0__

#else
#define _PANNEL_NAME                        _P__,_a__,_n__,_e__,_l__,__,_COLON__,__,_L__,_C__,_2__,_3__,_8__,_L__,_F__,_1__,_F__
#endif
//////////////////
// General Info //
//////////////////
...
#define _PANEL_MAX_FRAME_RATE           	1810//    1660
...
#define _PANEL_DH_TOTAL_MAX          			4300                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL                         1111                // Display Vertical Total Clock Number in One Display Line
#if _OVERCLOCK_180HZ
#define _PANEL_DV_TOTAL_MAX                 	6415//4000               // Maxinum Display Vertical Total Clock Number in One Display Line
#else
#define _PANEL_DV_TOTAL_MAX                 	4000               // Maxinum Display Vertical Total Clock Number in One Display Line
#endif
...
#define _PANEL_POWER_ON_T2                      30//  10                  // Panel Power On T2 (ms)
#define _PANEL_POWER_ON_T3                      250//   300//     400//   1500//     550                // Panel Power On T3 (ms)   //修改 logo先出来 后开背光
...
#define _PANEL_POWER_ON_T3                     300           // Panel Power On T3 (ms)   //修改 logo先出来 后开背光
...
//--------------------------------------------------
#define _LAST_LINE_TARGET                       (_PANEL_DH_TOTAL - 150)//1970
