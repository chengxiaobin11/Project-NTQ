...
bit ScalerFreeSyncHDMIRx0CheckAmdVsdbVer(void);
...
#else
    if(ScalerSyncGetAmdVsdbVer(_D0_INPUT_PORT) < _AMD_VER3)
#endif
    {
...
#if(_HDMI_MAC_PAGE2_USE == _ON)
//--------------------------------------------------
// Description  : Get AMD Vsdb Version
// Input Value  : None
// Output Value : True/False
//--------------------------------------------------
bit ScalerFreeSyncHDMIRx0CheckAmdVsdbVer(void)
{
    BYTE ucHdmiPort = ((_D2_HDMI_SUPPORT << 2) | (_D1_HDMI_SUPPORT << 1) | (_D0_HDMI_SUPPORT << 0));
    BYTE ucHmdiPortNum = 0x00;

    for(ucHmdiPortNum; ucHmdiPortNum < 3; ucHmdiPortNum++)
    {
        if(((ucHdmiPort >> ucHmdiPortNum) & 0x01) == 0x01)
        {
            if((CHECK_TMDS_DPHY_SWITCH(_D0_INPUT_PORT + ucHmdiPortNum) == _TRUE) && (ScalerSyncGetAmdVsdbVer(_D0_INPUT_PORT + ucHmdiPortNum) < _AMD_VER3))
            {
                return _TRUE;
                break;
            }
...
WORD ScalerFreeSyncHDMIRx0GetAmdSpdInfo(EnumAmdSpdInfoContent enumContent)
{
    ...
    if(ScalerFreeSyncHDMIRx0CheckAmdVsdbVer() == _TRUE)
    {
...
WORD ScalerFreeSyncHDMIRx2GetAmdSpdInfo(EnumAmdSpdInfoContent enumContent, bit bD1Combo)
{
    ...
    if(((ScalerSyncGetAmdVsdbVer(_D1_INPUT_PORT) < _AMD_VER3) && (bD1Combo == _ON)) || ((ScalerSyncGetAmdVsdbVer(_D2_INPUT_PORT) < _AMD_VER3) && (bD1Combo == _OFF)))
    {
        usAmdVfreqMaxBit = _8_BIT;
    }
    else
...
WORD ScalerFreeSyncHDMIRx3GetAmdSpdInfo(EnumAmdSpdInfoContent enumContent)
{
    ...
    if(ScalerSyncGetAmdVsdbVer(_D3_INPUT_PORT) < _AMD_VER3)
    {
        usAmdVfreqMaxBit = _8_BIT;
    }
    else
...
WORD ScalerFreeSyncHDMIRx4GetAmdSpdInfo(EnumAmdSpdInfoContent enumContent)
{
    ...
    if(ScalerSyncGetAmdVsdbVer(_D4_INPUT_PORT) < _AMD_VER3)
    {
        usAmdVfreqMaxBit = _8_BIT;
    }
    else
...
WORD ScalerFreeSyncHDMIRx5GetAmdSpdInfo(EnumAmdSpdInfoContent enumContent)
{
    ...
    if(ScalerSyncGetAmdVsdbVer(_D5_INPUT_PORT) < _AMD_VER3)
    {
        usAmdVfreqMaxBit = _8_BIT;
    }
    else
    ...
    switch(enumSourcePort)
    {
        ...
        case _D1_INPUT_PORT:
            ...
            if(GET_TMDS_RX1_FREESYNC_SUPPORT() != enumSupport)
            {
                ...
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D1_INPUT_PORT, _ENABLE);
                }
                else
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D1_INPUT_PORT, _DISABLE);
                }
#endif
            }
            break;
        ...
        case _D2_INPUT_PORT:
            ...
            if(GET_TMDS_RX2_FREESYNC_SUPPORT() != enumSupport)
            {
                ...
                if(enumSupport == _FREESYNC_SUPPORT_ON)
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D2_INPUT_PORT, _ENABLE);
                }
                else
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D2_INPUT_PORT, _DISABLE);
                }
#endif
            }
            break;
        ...
        case _D3_INPUT_PORT:
            ...
            if(GET_TMDS_RX3_FREESYNC_SUPPORT() != enumSupport)
            {
                ...
                if(enumSupport == _FREESYNC_SUPPORT_ON)
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D3_INPUT_PORT, _ENABLE);
                }
                else
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D3_INPUT_PORT, _DISABLE);
                }
#endif
            }
            break;
        ...
        case _D4_INPUT_PORT:
            ...
            if(GET_TMDS_RX4_FREESYNC_SUPPORT() != enumSupport)
            {
                ...
                if(enumSupport == _FREESYNC_SUPPORT_ON)
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D4_INPUT_PORT, _ENABLE);
                }
                else
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D4_INPUT_PORT, _DISABLE);
                }
#endif
            }
            break;
        ...
        case _D5_INPUT_PORT:
            ...
            if(GET_TMDS_RX5_FREESYNC_SUPPORT() != enumSupport)
            {
                ...
                if(enumSupport == _FREESYNC_SUPPORT_ON)
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D5_INPUT_PORT, _ENABLE);
                }
                else
                {
                    ScalerTMDSHdmiSetAmdAupiScdcInfo(_D5_INPUT_PORT, _DISABLE);
                }
#endif
            }
            break;
