...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449__216PIN__HK_M_RTD2775E05__1T1DP1H__eDPVB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//#define _PORT_NAME_STR_D3						_STR_INDEX_HDMI
//#define _D3_STR_INDEX_2
/////////////////////////////
...
#define _PANEL_DPTX_1_1_LANE_PN_SWAP           _DISABLE// _ENABLE
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SWING_LEVEL             _DP_SWING_1200_MV
#define _PANEL_DPTX_1_2_PREEMPHASIS_LEVEL       _DP_PREEMPHASIS_0_DB

//--------------------------------------------------
// eDPTx 1.2 HBR2 SSC Config
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SPREAD_RANGE            0
...
#define _PANEL_DPTX_1_2_LANE_PN_SWAP            _DISABLE//_ENABLE 2775ϵ��
...
#define _VBO_SPREAD_RANGE             0//   15//     3
...
#define _PCB_SYS_EEPROM_IIC                   _HW_IIC_PIN_210_211//  _SW_IIC_PIN_GPIO
...
// 0 ~ 7 (0: P9D4i<I>, 1: P9D4o<PP>, 2: _PIN_198P9D4o<OD>, 3: m1_idomain_hs_out, 4: test4b_out0
//        5: test4b_out1, 6:test4b_out2, 7:test4b_out3)
...
#define _USB_HUB_ON                      1
#define _USB_HUB_OFF                0


#define PCB_USB_HUB_POWER(x)                            (MCU_FE30_PORTA0_PIN_REG = x)//_PIN_202  PAD0o//        (P3_5 = x)											

#define _USB_POWER_ON                      1
#define _USB_POWER_OFF                0

//#define PCB_USB_POWER(x)                                  (MCU_FE22_PORT82_PIN_REG = x)	//_PIN_198 P9D4o	



sbit bTypeCDetect                               = P1^4 ;         // _PIN_67  P1D4i

// ��� type c ��������
#define GET_TYPEC_SWITCH()                  (bTypeCDetect)     


#define _HUB_INIT_OFF            	1
#define _HUB_INIT_ON               	0

#define _HUB_C                      0
#define _HUB_B               		1

#define HUB_SWITCH(x)                       	 (MCU_FE2C_PORT94_PIN_REG = x)//_PIN_198 9.4 
#define GET_HUB_SWITCH(x)                       	 (MCU_FE2C_PORT94_PIN_REG)//_PIN_198 9.4 
#define HUB_SWITCH_INIT(x)                        (MCU_FE2B_PORT93_PIN_REG = x)//_PIN_197 9.3
//////////////////////
// GPIO Power Macro //
//////////////////////

#define PCB_ON_REGION_GPIO_SETTING_POWER_AC_ON(){\
										     	    PCB_USB_HUB_POWER(_USB_HUB_ON)	;\
...
#define PCB_GPIO_SETTING_POWER_SAVING()         {\
													...
													PCB_USB_HUB_POWER(_USB_HUB_OFF) ;\
												}
...
#define bEEPROM_WRITE_PROTECT                   (MCU_FE36_PORTA6_PIN_REG) // Pin_209, P8D3o
#else
#define bEEPROM_WRITE_PROTECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_209, PA.6
#endif
...
#else
#define bEDID_WRITE_PROTECT                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_181, P8.3
#endif
...
#define bDDC2IICSCL         				    (MCU_FE39_PORTB1_PIN_REG) // _PIN_212, 
#define bDDC2IICSDA          					(MCU_FE3A_PORTB2_PIN_REG) // _PIN_213,
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                    (P1_7) // Pin_70, P1.7,//DP_SINK_ASS_P0
#define bD0_DP_PIN16_CONNECT                    (P1_6) // Pin_69, P1.6   //TYPEC_DET
#define bD0_DP_PIN17_CONNECT                    (P1_5) // Pin_68, P1.5,//DP_SINK_ASS_N0

#define bD1_DP_PIN15_CONNECT                    (MCU_FE34_PORTA4_PIN_REG) // Pin_207, PA.4,DP_SINK_ASS_P1
#define bD1_DP_PIN16_CONNECT                    (MCU_FE35_PORTA5_PIN_REG) // Pin_208, PA.5
#define bD1_DP_PIN17_CONNECT                    (MCU_FE33_PORTA3_PIN_REG) // Pin_206, PA.3,DP_SINK_ASS_N1
...
#define bD2_HPD                                 (P1_1) // _PIN_14, P1.1
...
//-----------------------------------------------
#define bD2_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_197, P9.3
#define bD3_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_196, P9.2
...
//-----------------------------------------------
#define bD2_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_195, P9.1
#define bD3_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_201, P9.7
...
#define bLED2                                   (MCU_FE29_PORT91_PIN_REG) // _PIN_195,  P9D1
...
#define IO_power                                (MCU_FE28_PORT90_PIN_REG) // _PIN_194,  9.0

#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
//#define bPOWER_KEY                              (P3_0)// Pin_71 P3.0

#if 1//(Project_ID == ID_TJ_HK2775E05_M270QAN060_EDP4LANHBR2_MD2722_UHD60HZ_20240229)
...
#define POWER_KEY								0x0

#define MENU_KEY								0x00
#define EXIT_KEY								0X80
#define LEFT_KEY								0xC8
#define RIGHT_KEY								0XC8
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
  ...
  sbit bHeadphoneDetect                     = P3 ^ 0; // _PIN_71, P3.0
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE2D_PORT95_PIN_REG) //  _PIN_199 P9D5o


#define _AMP_MUTE_ON                1//          0
#define _AMP_MUTE_OFF           0//    1
...
//-----------------------------------------------
// Macro of PCB Audio AMP  SD Control
//-----------------------------------------------

#define bPCBAMPSDCONTROL                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //  

#define _AMP_SD_ON                            0       // Amp Mute on state
#define _AMP_SD_OFF                           1       // Amp Mute off state
...
//#define PCB_USB_HUB_POWER(x)                                    (P3_5 = x)											

//#define _USB_POWER_ON                      1
//#define _USB_POWER_OFF                0

//#define PCB_USB_POWER(x)                                  (MCU_FE22_PORT82_PIN_REG = x)		
...
#define _MAIN_PAGE_MODEL_NAME                 _M__,_O__,_D__,_E__,_L__,_COLON__,_R__,_T__,_2__,_7__,_7__,_5__
#define _BURNIN_STR_IC_NAME                	  _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_7__,_7__,_5__,_E__,_0__,_5__
...
#define _Pin151_MPRT_TCON3				5		// TCON7
#define _Pin151_PWM					3	// IO
#if 1
//-----------------------------------------------
// Macro of MPRT CONTROL
//-----------------------------------------------
...
#define PCB_MPRT_TCON_PIN_SHARE_CONFIG(x)       {\
													if(x == _ON)\
													{\
														ScalerSetByte(0x1022, (BYTE)(_Pin151_MPRT_TCON3));\
													}\
													else\
													{\
														ScalerSetByte(0x1022, (BYTE)(_Pin151_PWM));\
													}\
												}
...
#define PCB_MPRT_TCON_ENABLE(x)                 {\
													if(x == _ON)\
													{\
														ScalerTcon3Enable(_ENABLE);\
													}\
													else\
													{\
														ScalerTcon3Enable(_DISABLE);\
													}\
												}
// // tcon7inv
#define PCB_MPRT_TCON_INVERTED_OUTPUT()         {\
													ScalerSetDataPortBit(P15_A3_TCON_ADDR, _P15_A4_PT_48_TC3_CTRL, ~(_BIT6), 0  );\
												}
    //ScalerSetDataPortBit(P15_A3_TCON_ADDR, _P15_A4_PT_48_TC3_CTRL, ~(_BIT7), ((BYTE)bEnable << 7));


// on/Backlight �ſ��ص͵�ƽ ��������TCON INVERTED
//Tcon H end >= OUTPUT D-HTOTAL;

#define PCB_MPRT_TCON_PWM_ADJUST()              {\
													ScalerTcon3Adjust(0x00, 0x1FFF, ( g_MPRTValue), (GET_MDOMAIN_OUTPUT_VTOTAL() - g_MPRTValue));\
												}




//  ��V �����Χ�� ���óɸߵ�ƽ��������Χ���óɵ͵�ƽ������on/Backlight �ſ���

// H �� ��Χ 0x00 �� 0x1FFF���ڣ�һֱ�Ǹߵ�ƽ
