...
/********************************************************************************/
#if(_PANEL_TYPE == _LG_LM270WQA_SSA1_EDP_QHD165HZ)
//----------------------------------------------------------------------------------------------------
// ID Code      : _AUO_VBO_27_WUXGA_FREESYNC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#define _PANNEL_NAME                        	_P__,_a__,_n__,_e__,_l__,__,_COLON__,__,_L__,_M__,_2__,_7__,_0__,_W__,_Q__,_A__,_SLINE__,_S__,_S__,_A__,_2__
//----------------------------------------------------------------------------------------------------
...
#define _PANEL_DH_TOTAL                        	2880// 2720
#define _PANEL_DH_TOTAL_MAX                     6000 
#define _PANEL_DH_TOTAL_MIN                    	2640// 2704

#define _PANEL_DV_START                         6
#define _PANEL_DV_HEIGHT                        1440
#define _PANEL_DV_END                           1446

#define _PANEL_DV_TOTAL                         1481//1543	
#define _PANEL_DV_TOTAL_MAX        			    8000 
#define _PANEL_DV_TOTAL_MIN                 	1456//1481

#define _PANEL_DH_SYNC_WIDTH                    8
#define _PANEL_DV_SYNC_HEIGHT                   2

#define _PANEL_PIXEL_CLOCK                     241//390 
#define _PANEL_PIXEL_CLOCK_MAX          	   700 
#define _PANEL_PIXEL_CLOCK_MIN             	   120//320 

#define _PANEL_POWER_ON_T1                     10//100
#define _PANEL_POWER_ON_T2                     20//200
#define _PANEL_POWER_ON_T3                     550//400

#define _PANEL_POWER_OFF_T4                    150//     100
#define _PANEL_POWER_OFF_T5                    50//     50
#define _PANEL_POWER_OFF_T6                    1010//800//     500
