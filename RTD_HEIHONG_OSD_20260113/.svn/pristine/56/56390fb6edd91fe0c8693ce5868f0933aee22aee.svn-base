    ...
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_PIN_198:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM4_PP:
                    ScalerSetBit(P10_30_PIN_SHARE_CTRL80, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
                    break;

                case _PWM4_OD:
                    ScalerSetBit(P10_30_PIN_SHARE_CTRL80, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
                    break;
...
void ScalerPinshareRx0TypeCPinAssert(EnumTypeCPinCfgType enumTypeCPinCfgType, EnumTypeCOrientation enumTypeCOrientation)
{
    ...
    {
        // Pin 71 Pinshare Config : GPI Mode
        ScalerSetBit(P10_08_PIN_SHARE_CTRL30, ~(_BIT2 | _BIT1 | _BIT0), 0x00);

        // Pin 72 Pinshare Config : GPI Mode
        ScalerSetBit(P10_09_PIN_SHARE_CTRL31, ~(_BIT2 | _BIT1 | _BIT0), 0x00);
    }
    else
    {
        // Pin 71 Pinshare Config : AUX_P Mode
        ScalerSetBit(P10_08_PIN_SHARE_CTRL30, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));

        // Pin 72 Pinshare Config : AUX_N Mode
        ScalerSetBit(P10_09_PIN_SHARE_CTRL31, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
    }
}
...
void ScalerPinshareRx1TypeCPinAssert(EnumTypeCPinCfgType enumTypeCPinCfgType, EnumTypeCOrientation enumTypeCOrientation)
{
    ...
    if(enumTypeCPinCfgType == _TYPE_C_PIN_ASSIGNMENT_NONE)
    {
        // Pin 73 Pinshare Config : GPI Mode
        ScalerSetBit(P10_0A_PIN_SHARE_CTRL32, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), _BIT7);
    ...
    {
        // Pin 73 Pinshare Config : AUX_P Mode
        ScalerSetBit(P10_0A_PIN_SHARE_CTRL32, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | _BIT1 | _BIT0));

        // Pin 74 Pinshare Config : AUX_N Mode
        ScalerSetBit(P10_0B_PIN_SHARE_CTRL33, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
    }
}
...
void ScalerPinshareRxHpdPullDownSet(BYTE ucInputPort, bit bEnable)
{
    ...
    switch(ucInputPort)
    {
        ...
        case _D1_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_7A_PIN_PULLUP_CTRL00, ~(_BIT3 | _BIT2), _BIT3);
            }
            else
            {
                ScalerSetBit(P10_7A_PIN_PULLUP_CTRL00, ~(_BIT3 | _BIT2), 0x00);
            }
            break;
#endif
        ...
        case _D3_INPUT_PORT:
            if(bEnable == _ENABLE)
            {
                ScalerSetBit(P10_7A_PIN_PULLUP_CTRL00, ~(_BIT5 | _BIT4), _BIT5);
            }
            else
            {
                ScalerSetBit(P10_7A_PIN_PULLUP_CTRL00, ~(_BIT5 | _BIT4), 0x00);
            }
            break;
#endif
        default:
