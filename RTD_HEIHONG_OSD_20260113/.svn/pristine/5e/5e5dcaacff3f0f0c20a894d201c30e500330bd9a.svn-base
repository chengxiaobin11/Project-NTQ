...
void OsdWindowDrawingHighlight(BYTE ucWindow, WORD usXStart, WORD usYStart, WORD usXEnd, WORD usYEnd, BYTE ucColor, BYTE ucForegroundColor, BYTE ucBackgroundColor, BYTE ucENABLE);
void OsdWindowDrawingByFont(BYTE ucWindow, BYTE ucRow, BYTE ucCol, BYTE ucWidth, BYTE ucHeight, BYTE ucColor);
void OsdMenuDrawingHighlight(BYTE ucWindow,BYTE ucForegroundColor, BYTE ucBackgroundColor, BYTE ucENABLE);
...
#endif
	if(ucWindow == _OSD_WINDOW_8)
	
{
		SET_OSD_WINDOW_COLOR_BORDER(_CP_WHITE);
		SET_OSD_WINDOW_SHADOW_BORDER_PIXEL_WIDTH(2);
		SET_OSD_WINDOW_SHADOW_BORDER_PIXEL_HEIGHT(2);
		SET_OSD_WINDOW_BUTTON_ENABLE(_ENABLE);
		SET_OSD_WINDOW_BUTTON_TYPE(7);
...
void OsdWindowDrawingHighlight(BYTE ucWindow, WORD usXStart, WORD usYStart, WORD usXEnd, WORD usYEnd, BYTE ucColor, BYTE ucForegroundColor, BYTE ucBackgroundColor, BYTE ucENABLE)
{
    ...
    ScalerOsdWindowHighlightFunction(ucENABLE, ucWindow, ucForegroundColor, ucBackgroundColor, _CP_BG);
}
