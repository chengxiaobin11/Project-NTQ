...
//#define _INPUTSOURCE_OSD_SETTING   		_A0D1D2_INPUT// _A0VGA_D1HDMI_D2D3DUALDVI   
//========================================
////////////////////
// For LVDS Panel //
////////////////////
...
#define _DP_1                                       _D0_DP_PORT
#define _DP_2                                       _D1_HDMI_PORT
#define _HDMI_1                                     _D1_HDMI_PORT//_D2_DVI_PORT
#define _HDMI_2                                     _D3_HDMI_PORT//_NO_INPUT_PORT
//--------------------------------------------------
// LVDS Port Config
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
														if(0)\
														{\
                                                   			 if(!((SysModeGetModeState() == _MODE_STATUS_NOSIGNAL)&&(GET_BURNIN_MODE() == _ON)))\
...
#define PCB_PWM_SETTING()                       {\
                                                ...
                                                //ScalerMcuPwmAdjustFrequency(_AUDIO_VOLUMN_PWM, 55000);
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_7_,_8_,_5_,_T_
#define _BURNIN_STR_IC_NAME                	  _R_,_T_,_D_,_2_,_7_,_8_,_5_,_T_



#endif // End of #if(_PCB_TYPE == _RL6432_SG_A_216PIN_1A1DUALD1H_DPTX_LVDS_eDP)
