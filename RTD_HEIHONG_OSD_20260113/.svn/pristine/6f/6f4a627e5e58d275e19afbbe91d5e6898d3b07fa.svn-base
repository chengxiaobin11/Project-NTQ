...
#define GET_AUDIO_D1_FW_TRACKING_STATE()            (g_stHDMID1AudioFwTrackingInfo.b2AudioFwTrackState)
#define SET_AUDIO_D1_FW_TRACKING_STATE(x)           (g_stHDMID1AudioFwTrackingInfo.b2AudioFwTrackState = (x))

#define GET_AUDIO_D1_FW_TRACKING_EVENT()            (bit)(g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackEventStatus)
#define SET_AUDIO_D1_FW_TRACKING_EVENT()            (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _TRUE)
#define CLR_AUDIO_D1_FW_TRACKING_EVENT()            (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _FALSE)

#define GET_AUDIO_D1_FW_TRACKING_TIMEOUT()          (bit)(g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent)
#define SET_AUDIO_D1_FW_TRACKING_TIMEOUT()          (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _TRUE)
#define CLR_AUDIO_D1_FW_TRACKING_TIMEOUT()          (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _FALSE)

#define GET_AUDIO_D1_FW_TRACKING_RESET()            (bit)(g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackReset)
#define SET_AUDIO_D1_FW_TRACKING_RESET()            (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackReset = _TRUE)
#define CLR_AUDIO_D1_FW_TRACKING_RESET()            (g_stHDMID1AudioFwTrackingInfo.b1AudioFwTrackReset = _FALSE)

#define GET_AUDIO_D1_WL_TARGET_DIRECTION()          (g_stHDMID1AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection)
#define SET_AUDIO_D1_WL_TARGET_DIRECTION(x)         (g_stHDMID1AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = (x))
#define CLR_AUDIO_D1_WL_TARGET_DIRECTION()          (g_stHDMID1AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = _AUDIO_WL_GOES_UNKNOWN)
#endif
...
#if(_D1_HDMI_SUPPORT == _ON)
extern StructAudioFwTrackingInfo g_stHDMID1AudioFwTrackingInfo;
#endif
