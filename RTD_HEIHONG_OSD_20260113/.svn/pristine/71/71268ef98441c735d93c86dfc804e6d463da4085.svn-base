...
// Tx Edid Size
//--------------------------------------------------
#define _DP_TX_EDID_SIZE_MAX                                _EDID_SIZE_512
...
extern BYTE g_pucDpTxPreviousDfpDeviceEdidBackup[_DP_TX_EDID_SIZE_MAX];
#endif
...
#if(_DP_TX_EDID_MODIFY_REMOVE_HDR_FS2_SUPPORT == _ON)
extern bit ScalerDpTxGetDfpDeviceStoredEdid(WORD usOffset, BYTE ucLength, BYTE *pucDataArray);
#endif
