...
//-----------------------------------------------
// Macro of PMIC VBUS Capacitance Control
//-----------------------------------------------
#define bPMIC_VBUS_CAP_CONTROL                  _PIN_23_MCU_REG

#define _VBUS_CAP_CONNECT                       1
#define _VBUS_CAP_DISCONNECT                    0

#define PCB_PMIC_VBUS_CAP_CONTROL(x)            {\
                                                    bPMIC_VBUS_CAP_CONTROL = (x);\
                                                }
...
//--------------------------------------------------
// Macro of Type-C GPIO PIN PU-PD Control
//--------------------------------------------------
#define _D0_TPC_AUX_N_PUPD_CONTROL              (P10_A1_PIN_PULLUP_CTRL01__ON1)
#define _D0_TPC_AUX_P_PUPD_CONTROL              (P10_A2_PIN_PULLUP_CTRL02__ON1)

#define _D0_TPC_AUX_N_PUPD_START_BIT            0
#define _D0_TPC_AUX_P_PUPD_START_BIT            6

#define _NOT_CONNECTED                          0x00
#define _PU_CONNECTED                           _BIT0
#define _PD_CONNECTED                           _BIT1

#define PCB_D0_TPC_AUX_N_PUPD_CONTROL(x)        {\
                                                    ScalerSetBit(_D0_TPC_AUX_N_PUPD_CONTROL, ~((_BIT1 | _BIT0) << _D0_TPC_AUX_N_PUPD_START_BIT), ((x) << _D0_TPC_AUX_N_PUPD_START_BIT));\
                                                }

#define PCB_D0_TPC_AUX_P_PUPD_CONTROL(x)        {\
                                                    ScalerSetBit(_D0_TPC_AUX_P_PUPD_CONTROL, ~((_BIT1 | _BIT0) << _D0_TPC_AUX_P_PUPD_START_BIT), ((x) << _D0_TPC_AUX_P_PUPD_START_BIT));\
                                                }
