...
#define _PANEL_DPTX_1_2_LANE_PN_SWAP            _DISABLE//_ENABLE 2775?  
#else
#define _PANEL_DPTX_1_2_LANE_PN_SWAP            _DISABLE//_ENABLE 2775?  
#endif
...
// HDMI_CABLE_DETECT_3
#define _PIN_198                                (2 & 0x0F) // Page 10-0x3C[2:0]
...
#define bREGULATOR_5V                       (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//    (MCU_FE22_PORT82_PIN_REG) // Pin_180, P8.2
...
#define bCC_SW                        (MCU_FE22_PORT82_PIN_REG) // Pin_180, P8.2


#define PCB_CC_SW_OUT(x)                 {\
                                                    bCC_SW = (x);\
                                                }
...
#define bD0_CONNECT                             bD0_DP_PIN16_CONNECT//(((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
...
#define IO_power                                (MCU_FE2A_PORT92_PIN_REG) // _PIN_196,  9.2
...
#define EXIT_KEY								0Xc8
#define POWER_KEY 								0xC8
...
// on/Backlight 脚开关低电平 反向，所以TCON INVERTED
...
//  在V 这个范围内 ，置成高电平，超出范围，置成低电平，控制on/Backlight 脚开关

// H 在 范围 0x00 到 0x1FFF，内，一直是高电平
