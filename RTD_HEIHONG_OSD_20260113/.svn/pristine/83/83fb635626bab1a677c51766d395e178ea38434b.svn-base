...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__SG26eDP_HTU_WS_R10_1__1H1TYPEC2USB__eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__SG26eDP_HTU_WS_R10_1__1H1TYPEC2USB__eDP)
...
#define _D0_DDC_CHANNEL_SEL                   	_DDC0 // _DDC0
#define _D0_EMBEDDED_DDCRAM_MAX_SIZE            _EDID_SIZE_256// _EDID_SIZE_256//_EDID_SIZE_NONE
#define _D0_EMBEDDED_DDCRAM_LOCATION         	_EDID_TABLE_LOCATION_CODE//   _EDID_TABLE_LOCATION_USER
...
#define _D3_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_CODE//_EDID_TABLE_LOCATION_USER
//#define _D3_DP_CONNECTOR_TYPE                   _DP_CONNECTOR_NORMAL
//#define _D3_DP_LINK_CLK_RATE                    _DP_HIGH_SPEED2_540MHZ
//#define _D3_DP_MAIN_LINK_LANES                  _DP_FOUR_LANE
...
//--------------------------------------------------
#define _D0_DP_PCB_LANE0_MAPPING                _DP_SCALER_LANE1
#define _D0_DP_PCB_LANE1_MAPPING                _DP_SCALER_LANE3
#define _D0_DP_PCB_LANE2_MAPPING                _DP_SCALER_LANE2
#define _D0_DP_PCB_LANE3_MAPPING                _DP_SCALER_LANE0
...
#define _LVDS_DATA_SWAP                            _DISABLE
#endif
...
#define _AUDIO_VOLUMN_PWM						_PWM4
#define _AUDIO_VOLUMN_PWM_INVERSE				_OFF
...
// DP_SINK_ASS_N0
#define _156PIN_PIN_131                         (0 & 0x0F) // Page 10-0x05[2:0]
...
// TYPE-C 5V EN 
#define _156PIN_PIN_133                         (2 & 0x0F) // Page 10-0x07[2:0]
...
// NC
#define _156PIN_PIN_152                         (0 & 0x0F) // Page 10-0x15[2:0]
// 0 ~ 4 (0: P4D5i<I>, 1: P4D5o<PP>, 2: P4D5o<OD>, 3: line_inr, 4: sck)

// NC(AUDIO_REF)
#define _156PIN_PIN_153                         (0 & 0x0F) // Page 10-0x16[2:0]
...
//NC
#define _156PIN_PIN_47_OFF_REGION               (2 & 0x0F) // Page 10-0x22[2:0]
...
// IR
#define _156PIN_PIN_63                          (6 & 0x0F) // Page 10-0x2A[2:0]
// 0 ~ 6 (0: P7D2i<I>, 1: P7D2o<PP>, 2: P7D2o<OD>, 3: PWM2<PP>, 4: PWM2<OD>,
//        5: TCON[1],  6: IRDA_in )

// BACKLIGHT_ONOFF
#define _156PIN_PIN_64                          (1 & 0x0F) // Page 10-0x2C[2:0]  //2
...
// AUDIO ADJ
#define _156PIN_PIN_67                          (4 & 0x0F) // Page 10-0x30[2:0]
...
// DP_HOT_PLUG_0
#define _156PIN_PIN_70                          (2 & 0x0F) // Page 10-0x32[2:0]
...
//NC
#define _156PIN_PIN_77                          (0 & 0x0F) // Page 10-0x3A[2:0]
// 0 ~ 8 (0: P9D2i<I>, 1: P9D2o<PP>, 2: P9D2o<OD>, 3: PWM0<PP>, 4: PWM0<OD>
//        5: TCON[1],  8: EEIICSCL)

//NC
#define _156PIN_PIN_78                          (0 & 0x0F) // Page 10-0x3B[2:0]
...
// GPIO Power Macro //
//////////////////////
#define _USB_HUB_CTRL
#if defined(_USB_HUB_CTRL)

sbit bUSB_ENABLE                                = P1 ^ 7; // _156PIN_PIN_133, P1.7
#define _USB_ON										 0
#define _USB_OFF									 1

  
#define PCB_USB_ENABLE_PLUG()                      	 {\
														bUSB_ENABLE = (_USB_OFF);\
...
#define PCB_GPIO_ON_REGION_INITIAL_SETTING()    {\
													...
													PCB_USB_ENABLE(_USB_ON);\
                                                }
#elif(_PANEL_STYLE == _PANEL_LVDS)
#define PCB_GPIO_ON_REGION_INITIAL_SETTING()    {\
                                                    PCB_SET_LVDS_DPTX_SWITCH(_LVDS_PANEL_OUTPUT);\
													PCB_HUB_POWER(_HUB_POWER_ON);\
													PCB_USB_ENABLE(_USB_ON);\
                                                   }
#endif
#if 0//(_PANEL_STYLE == _PANEL_DPTX)
#define PCB_DPTX_HPD               (MCU_FE0B_PORT53_PIN_REG)
#define PCB_DPTX1_POWER_SEQUENCE(x)                         {\ PCB_DPTX_HPD  =(x) \
							}
#endif

/*
PCB_TYPEC_POWER(_TYPEC_POWER_ON);\
*/
//-----------------------------------------------
...
//-----------------------------------------------
#define bVCCKOFFPOWER                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //  // 156PIN_PIN_47, P6.2    MCU_FE12_PORT62_PIN_REG
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _156PIN_PIN_49, P6.4   MCU_FE14_PORT64_PIN_REG
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE1F_PORT77_PIN_REG) // 156PIN_PIN_66, P7.7
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_68, P8.1
...
sbit bD0_DP_PIN15_CONNECT                       		= P1 ^ 6;   // _156PIN_PIN_132, P1.6 D0->DP DP_SINK_ASS_P0
sbit bD0_DP_PIN16_CONNECT                       		= P1 ^ 3;    // _156PIN_PIN_118, P1.3 D0->DP DP_CABLE_DET_0
sbit bD0_DP_PIN17_CONNECT                       		= P1 ^ 5;   // _156PIN_PIN_131, P1.5 D0->DP DP_SINK_ASS_N0
//#define GET_PCB_D0_DP_SOURCE_POWER()               (bD0_DP_PIN17_CONNECT)


#define bD1_DP_PIN15_CONNECT                       		(MCU_FE27_PORT87_PIN_REG) // _156PIN_PIN_74, P8.7 D1->DP DP_SINK_ASS_P1
sbit bD1_DP_PIN16_CONNECT                       		= P1 ^ 4;    // _156PIN_PIN_119, P1.4 D1->DP DP_CABLE_DET_1
#define bD1_DP_PIN17_CONNECT                       		(MCU_FE26_PORT86_PIN_REG)   // _156PIN_PIN_73, P8.6 D1->DP DP_SINK_ASS_N1

sbit bD0_DP_CONNECT                              = (P1 ^ 3);
sbit bD1_DP_CONNECT                              = (P1 ^ 4);


#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _TRUE) &&((bit)bD0_DP_CONNECT == _TRUE)&&  ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
#define bD1_CONNECT                             (((bit)bD1_DP_PIN15_CONNECT == _TRUE) &&((bit)bD1_DP_CONNECT == _TRUE)&&  ((bit)bD1_DP_PIN17_CONNECT == _FALSE))
sbit bD3_CONNECT                              = P1 ^ 0;// PIN_1, P1.0BUG
...
//-----------------------------------------------
#define bD1_MHL_CONNECT                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // 156PIN_PIN_65 , P7.5

#define PCB_D1_MHL_DETECT()                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS)

#define bD1_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_63, P7.2
...
sbit bD3_HPD                                    = P1 ^ 1; // 156PIN_PIN_84, P1.1
...
//-----------------------------------------------
#define bD1_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_64, P7.4
...
//-----------------------------------------------
#define bREGULATOR_5V                          (MCU_FE30_PORTA0_PIN_REG) // Pin_81, PA.0
...
//--------------------------------------------------
#define bLVDSDPTXSWICH                          (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_48, P6.3   MCU_FE13_PORT63_PIN_REG
...
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_77   MCU_FE2A_PORT92_PIN_REG
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // Pin_78   MCU_FE2B_PORT93_PIN_REG
...
#define PCB_SW_IIC_SDA_SET()                    {\
                                                    ...
                                                    if(GET_SW_IIC_STATUS() == _IIC_SMBUS)\
                                                    {\
                                                        bSWIIC_SYS_EEPROM_SDA = _TRUE;\
                                                    }\
                                                }
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, (((DWORD)_PANEL_TYP_FRAME_RATE * 160) / 100));\
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_FE24_PORT84_PIN_REG) // _156PIN_PIN_71, P8.4
#define bLED2                                   (MCU_FE25_PORT85_PIN_REG) // _156PIN_PIN_72 P8.5

#define bLED3                                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_154, P4.7
#define bLED4                                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_155, P5.0
...
#define bPOWER_KEY                              (MCU_FE29_PORT91_PIN_REG) // _156PIN_PIN_76, P9.1


#define PCB_KEY_STATE(ucV0, ucV1,\
								ucV2, ucV3, ucKeyState)   {\
																if((0xb0 <= (ucV2)) && ((ucV2) < 0xf0))\
																{\
																	(ucKeyState) |= _MENU_KEY_MASK ;\
																}\
																if((0xb0 <= (ucV1)) && ((ucV1) < 0xf0))\
																{\
																	(ucKeyState) |= _LEFT_KEY_MASK ;\
																}\
																if((0x60 <= (ucV1)) && ((ucV1) < 0x90))\
																{\
																	(ucKeyState) |= _RIGHT_KEY_MASK;\
																}\
																if((0x60 <= (ucV2)) && ((ucV2) < 0x98))\
																{\
...
#define bHeadphoneDetect                                    (MCU_FE04_PORT44_PIN_REG)//_156PIN_PIN_151,P4.4
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE1D_PORT75_PIN_REG)
...
//-----------------------------------------------
// Macro of PCB HUB_POWER_EN Control
//-----------------------------------------------
//#define bPCBHUBPOWERCONTROL                      (MCU_FE30_PORTA0_PIN_REG)
#define bPCBHUBPOWERCONTROL                      (MCU_FE05_PORT45_PIN_REG)

#define _HUB_POWER_ON                            0
#define _HUB_POWER_OFF                           1

#define PCB_HUB_POWER(x)                         {\
                                                    bPCBHUBPOWERCONTROL = (x);\
                                                	}



#define _MAIN_PAGE_MODEL_NAME                 _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_S_,_G_,_2_,_6_,_e_,_D_,_P_
#define _BURNIN_STR_IC_NAME                	  _S_,_G_,_2_,_6_,_e_,_D_,_P_

#endif // End of #if(_PCB_TYPE == _RL6432__156PIN__SG26eDP_HTU_WS_R10_1__1H1TYPEC2USB__eDP)
