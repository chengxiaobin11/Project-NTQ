...
#if(_PANEL_TYPE == _AUO_M250HTN01_0_VBY_240HZ)
//----------------------------------------------------------------------------------------------------
// ID Code      : _AUO_VBO_27_WUXGA_FREESYNC.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#define _PANNEL_NAME                            _P_,_N_,_L_,_,_COLON__,_,_M_,_2_,_5_,_0_,_H_,_T_,_N_,_0_,_1_,_0_
//#define _PANNEL_NAME                            _P_,_N_,_L_,_,_COLON__,_,_M_,_2_,_7_,_0_,_H_,_T_,_N_,_0_,_2_,_0_
