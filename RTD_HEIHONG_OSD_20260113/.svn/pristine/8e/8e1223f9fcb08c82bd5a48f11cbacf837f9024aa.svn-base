...
StructHdmiSpdInfo g_stTmdsMacRx4SpdInfo;
#endif
...
#if(_HDMI_IDENTIFY_GAME_SRC_SUPPORT == _ON)
void ScalerTMDSRx4SpdInfoPacketDetect(bit bWait);
void ScalerTMDSRx4HdmiGetSpdInfo(void);
#endif
...
#if(_HDMI_IDENTIFY_GAME_SRC_SUPPORT == _ON)
        ScalerTMDSRx4SpdInfoPacketDetect(_WAIT);
#endif
...
#if(_HDMI_IDENTIFY_GAME_SRC_SUPPORT == _ON)
        ScalerTMDSRx4SpdInfoPacketDetect(_NOT_WAIT);
#endif
...
void ScalerTMDSRx4HdmiGetSpdInfo(void)
{
    ...
    ScalerGetDataPortByte(P73_CD_HDMI_PSAP, 0x90, 4, &pucHdmiVenderName[0], _AUTOINC);
       ...
       ((pucHdmiVenderName[3] == 'T') || (pucHdmiVenderName[3] == 'I')))
    {
        ...
        memcpy(&g_stTmdsMacRx4SpdInfo.pucHdmiVendorName[0], pucHdmiVenderName, 4);

        ScalerGetDataPortByte(P73_CD_HDMI_PSAP, 0x98, 8, &g_stTmdsMacRx4SpdInfo.pucHdmiProductDescription[0], _AUTOINC);
    }
}
#endif
