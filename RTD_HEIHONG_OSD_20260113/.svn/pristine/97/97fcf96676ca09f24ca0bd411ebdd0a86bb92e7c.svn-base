...
EnumPdoCheck SysTypeCCheckSrcPdoChange(BYTE ucInputPort, BYTE ucPdoIndex, StructTypeCUserPDO stTypeCUserPdo);
...
void SysTypeCInitial(void)
{
    ...
    SysTypeCSetPortCtrlInitRequest(_D0_INPUT_PORT);
    ...
    SysTypeCSetPortCtrlInitRequest(_D1_INPUT_PORT);
    ...
    SysTypeCSetPortCtrlInitRequest(_D6_INPUT_PORT);
...
EnumPdoCheck SysTypeCCheckSrcPdoChange(BYTE ucInputPort, BYTE ucPdoIndex, StructTypeCUserPDO stTypeCUserPdo)
{
    ...
    stTypeCSrcPdo = SysTypeCGetPdo(ucInputPort, _TYPE_C_POWER_SRC, ucPdoIndex);

    // Check if PDO Content Change
    if(stTypeCSrcPdo.enumPdoType != stTypeCUserPdo.enumPdoType)
    {
        return _TYPE_C_PDO_CHANGE;
    }
        ...
        case _D0_INPUT_PORT:
            ...
            if(UserCommonPortControllerPdoReference(_D0_INPUT_PORT, _TYPE_C_POWER_SRC) == _TYPE_C_PDO_FROM_USER)
            {
                ...
                for(ucPdoIndex = 1; ucPdoIndex <= ucTotalPdoCount; ucPdoIndex++)
                {
                    ...
                    if(SysTypeCCheckSrcPdoChange(_D0_INPUT_PORT, ucPdoIndex, stTypeCUserPdo) == _TYPE_C_PDO_CHANGE)
                    {
        ...
        case _D1_INPUT_PORT:
            ...
            if(UserCommonPortControllerPdoReference(_D1_INPUT_PORT, _TYPE_C_POWER_SRC) == _TYPE_C_PDO_FROM_USER)
            {
                ...
                for(ucPdoIndex = 1; ucPdoIndex <= ucTotalPdoCount; ucPdoIndex++)
                {
                    ...
                    if(SysTypeCCheckSrcPdoChange(_D1_INPUT_PORT, ucPdoIndex, stTypeCUserPdo) == _TYPE_C_PDO_CHANGE)
                    {
        ...
        case _D6_INPUT_PORT:
            ...
            if(UserCommonPortControllerPdoReference(_D6_INPUT_PORT, _TYPE_C_POWER_SRC) == _TYPE_C_PDO_FROM_USER)
            {
                ...
                for(ucPdoIndex = 1; ucPdoIndex <= ucTotalPdoCount; ucPdoIndex++)
                {
                    ...
                    if(SysTypeCCheckSrcPdoChange(_D6_INPUT_PORT, ucPdoIndex, stTypeCUserPdo) == _TYPE_C_PDO_CHANGE)
                    {
...
void SysTypeCSetPortCtrlInitRequest(BYTE ucInputPort)
{
    ...
    StructTypeCUserInitRDO stTypeCInitUserRdo = {_TYPE_C_REQ_TARGET_VOL, _TYPE_C_RDO_5_1V};
#else
