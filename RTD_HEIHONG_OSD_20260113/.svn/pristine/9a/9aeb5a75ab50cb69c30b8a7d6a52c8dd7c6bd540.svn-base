...
#define GET_AUDIO_D4_AUTO_LOAD_FREQ()               (g_stAudioD4FreqParameter.b1AutoLoad)
#define SET_AUDIO_D4_AUTO_LOAD_FREQ()               (g_stAudioD4FreqParameter.b1AutoLoad = _TRUE)
#define CLR_AUDIO_D4_AUTO_LOAD_FREQ()               (g_stAudioD4FreqParameter.b1AutoLoad = _FALSE)

#define GET_D4_SAMPLING_FREQ_USER_DEFINE()          (g_stAudioD4FreqParameter.ucAudioFs)
#define SET_D4_SAMPLING_FREQ_USER_DEFINE(x)         (g_stAudioD4FreqParameter.ucAudioFs = (x))

#if(_HDMI_AUDIO_FW_TRACKING_MODE_SUPPORT == _ON)
#define GET_AUDIO_D4_FW_TRACKING_STATE()            (g_stHDMID4AudioFwTrackingInfo.b2AudioFwTrackState)
#define SET_AUDIO_D4_FW_TRACKING_STATE(x)           (g_stHDMID4AudioFwTrackingInfo.b2AudioFwTrackState = (x))

#define GET_AUDIO_D4_FW_TRACKING_EVENT()            (bit)(g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackEventStatus)
#define SET_AUDIO_D4_FW_TRACKING_EVENT()            (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _TRUE)
#define CLR_AUDIO_D4_FW_TRACKING_EVENT()            (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _FALSE)

#define GET_AUDIO_D4_FW_TRACKING_TIMEOUT()          (bit)(g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent)
#define SET_AUDIO_D4_FW_TRACKING_TIMEOUT()          (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _TRUE)
#define CLR_AUDIO_D4_FW_TRACKING_TIMEOUT()          (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _FALSE)

#define GET_AUDIO_D4_FW_TRACKING_RESET()            (bit)(g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackReset)
#define SET_AUDIO_D4_FW_TRACKING_RESET()            (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackReset = _TRUE)
#define CLR_AUDIO_D4_FW_TRACKING_RESET()            (g_stHDMID4AudioFwTrackingInfo.b1AudioFwTrackReset = _FALSE)

#define GET_AUDIO_D4_WL_TARGET_DIRECTION()          (g_stHDMID4AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection)
#define SET_AUDIO_D4_WL_TARGET_DIRECTION(x)         (g_stHDMID4AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = (x))
#define CLR_AUDIO_D4_WL_TARGET_DIRECTION()          (g_stHDMID4AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = _AUDIO_WL_GOES_UNKNOWN)
#endif
#endif
...
#define GET_AUDIO_D5_AUTO_LOAD_FREQ()               (g_stAudioD5FreqParameter.b1AutoLoad)
#define SET_AUDIO_D5_AUTO_LOAD_FREQ()               (g_stAudioD5FreqParameter.b1AutoLoad = _TRUE)
#define CLR_AUDIO_D5_AUTO_LOAD_FREQ()               (g_stAudioD5FreqParameter.b1AutoLoad = _FALSE)

#define GET_D5_SAMPLING_FREQ_USER_DEFINE()          (g_stAudioD5FreqParameter.ucAudioFs)
#define SET_D5_SAMPLING_FREQ_USER_DEFINE(x)         (g_stAudioD5FreqParameter.ucAudioFs = (x))

#if(_HDMI_AUDIO_FW_TRACKING_MODE_SUPPORT == _ON)
#define GET_AUDIO_D5_FW_TRACKING_STATE()            (g_stHDMID5AudioFwTrackingInfo.b2AudioFwTrackState)
#define SET_AUDIO_D5_FW_TRACKING_STATE(x)           (g_stHDMID5AudioFwTrackingInfo.b2AudioFwTrackState = (x))

#define GET_AUDIO_D5_FW_TRACKING_EVENT()            (bit)(g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackEventStatus)
#define SET_AUDIO_D5_FW_TRACKING_EVENT()            (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _TRUE)
#define CLR_AUDIO_D5_FW_TRACKING_EVENT()            (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackEventStatus = _FALSE)

#define GET_AUDIO_D5_FW_TRACKING_TIMEOUT()          (bit)(g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent)
#define SET_AUDIO_D5_FW_TRACKING_TIMEOUT()          (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _TRUE)
#define CLR_AUDIO_D5_FW_TRACKING_TIMEOUT()          (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackTimeoutEvent = _FALSE)

#define GET_AUDIO_D5_FW_TRACKING_RESET()            (bit)(g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackReset)
#define SET_AUDIO_D5_FW_TRACKING_RESET()            (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackReset = _TRUE)
#define CLR_AUDIO_D5_FW_TRACKING_RESET()            (g_stHDMID5AudioFwTrackingInfo.b1AudioFwTrackReset = _FALSE)

#define GET_AUDIO_D5_WL_TARGET_DIRECTION()          (g_stHDMID5AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection)
#define SET_AUDIO_D5_WL_TARGET_DIRECTION(x)         (g_stHDMID5AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = (x))
#define CLR_AUDIO_D5_WL_TARGET_DIRECTION()          (g_stHDMID5AudioFwTrackingInfo.b2AudioWaterLevelTargetDirection = _AUDIO_WL_GOES_UNKNOWN)
#endif
#endif
...
// Definitions of Audio DP Capability info
//--------------------------------------------------
#define GET_AUDIO_DP_D6_CAPABILITY_SWITCH()         (g_stAudioDpCapabilityInfo.b1DpD6CapabilitySwitch)
#define SET_AUDIO_DP_D6_CAPABILITY_SWITCH()         (g_stAudioDpCapabilityInfo.b1DpD6CapabilitySwitch = _TRUE)
#define CLR_AUDIO_DP_D6_CAPABILITY_SWITCH()         (g_stAudioDpCapabilityInfo.b1DpD6CapabilitySwitch = _FALSE)

#define GET_AUDIO_DP_D6_SUPPORT()                   (g_stAudioDpCapabilityInfo.b1DpD6Support)
#define SET_AUDIO_DP_D6_SUPPORT(x)                  (g_stAudioDpCapabilityInfo.b1DpD6Support = (x))
...
#if((_D6_INPUT_PORT_TYPE == _D6_DP_PORT) && (_D6_INPUT_PORT_SWITCH_FROM == _SWITCH_FROM_D0))
    EnumAudioDpDpcdSupport b1DpD6Support : 1;
#endif // End of #if((_D6_INPUT_PORT_TYPE == _D6_DP_PORT) && (_D6_INPUT_PORT_SWITCH_FROM == _SWITCH_FROM_D0))
...
extern StructAudioFreqParameter g_stAudioD4FreqParameter;

#if(_AUDIO_FW_TRACKING_MODE_SUPPORT == _ON)
extern StructAudioFwTrackingInfo g_stHDMID4AudioFwTrackingInfo;
#endif
#endif

#if(_D5_HDMI_SUPPORT == _ON)
extern StructAudioDigitalInfo g_stAudioD5DigtalInfo;
extern StructAudioFreqParameter g_stAudioD5FreqParameter;

#if(_AUDIO_FW_TRACKING_MODE_SUPPORT == _ON)
extern StructAudioFwTrackingInfo g_stHDMID5AudioFwTrackingInfo;
#endif
#endif
