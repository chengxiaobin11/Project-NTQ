...
// EDID Table
//--------------------------------------------------
#if((_D5_INPUT_PORT_TYPE == _D5_HDMI_PORT && _HDMI_24C02_SUPPORT) ||(_WRITE_EDID_TO_SYSTEM_EEPROM == _ON) || ((_D5_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE) && (_D5_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_CODE)))
