...
void ScalerDisplayDPTx1SignalInitialSetting(void)
{
    ...
    {
        // Set TX1 DPHY to APHY mux from MAC0 lane 0 1 --> 3 2
        ScalerSetByte(P38_84_DPTX_LANE_SWAP1_0, 0x23);
    }
    else
    {
        // Set TX1 DPHY to APHY mux from MAC0 lane 3 2 1 0 --> 1 0 3 2
        ScalerSetByte(P38_83_DPTX_LANE_SWAP3_2, 0x23);
        ScalerSetByte(P38_84_DPTX_LANE_SWAP1_0, 0x01);
    }
#else
    // Set TX1 DPHY to APHY mux from MAC0 lane 0 1 2 3 --> 2 3 0 1
