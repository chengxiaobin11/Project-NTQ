...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__JY85QS_UPH_LS_R10_1__1H1DP__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__SG85QS_1P1H_LS_R10_1__1P1H__LVDS)
...
// DDCSDA_VGA
#define _156PIN_PIN_132                         (2 & 0x0F) // Page 10-0x06[2:0]
...
// GPIO Power Macro //
//////////////////////
sbit bUSB_ENABLE                                = P1 ^ 6;  // 156PIN_PIN_133, P1.7
...
sbit bD1_DP_PIN16_CONNECT                     = P1 ^ 4; // 156PIN_PIN_119, P1.4
...
//--------------------------------------------------
#if 0//(_LED_SWAP ==_ON)
#define bLED1                                   (MCU_FE25_PORT85_PIN_REG) // 156PIN_PIN_72, P8.5
#define bLED2                                   (MCU_FE24_PORT84_PIN_REG) // 156PIN_PIN_71, P8.4 
#else
...
sbit bHeadphoneDetect                                    = P1 ^ 7;//= P3 ^ 0; // 156PIN_PIN_136, P3.1
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,_,_COLON_,_,_J_,_Y_,_8_,_5_,_Q_,_S_
#define _BURNIN_STR_IC_NAME                	  _R_,_T_,_D_,_2_,_5_,_5_,_6_,_Q_,_R_

#endif // End of #if(_PCB_TYPE == _RL6432__156PIN__JY85QS_UPH_LS_R10_1__1H1DP__LVDS)
