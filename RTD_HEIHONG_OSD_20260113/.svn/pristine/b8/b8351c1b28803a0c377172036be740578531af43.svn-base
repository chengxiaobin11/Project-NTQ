...
#define GET_SOURCE_BG_DETECT_ENABLE()           (g_stInputInfo.b1SourceBgDetectEn)
#define SET_SOURCE_BG_DETECT_ENABLE()           (g_stInputInfo.b1SourceBgDetectEn = 1)
#define CLR_SOURCE_BG_DETECT_ENABLE()           (g_stInputInfo.b1SourceBgDetectEn = 0)
#endif
#endif
...
extern bit SysTypeCGetPortControllerFwVersion(BYTE ucInputPort, StructTypeCPortCtrlFwVersion *pstTypeCFwVersion);
extern bit SysTypeCGetPortControllerMultiFunctionChangeDone(BYTE ucInputPort);
extern StructTypeCCableInfoForDpcd SysTypeCGetPortControllerCableInfoForDpcd(BYTE ucInputPort);
