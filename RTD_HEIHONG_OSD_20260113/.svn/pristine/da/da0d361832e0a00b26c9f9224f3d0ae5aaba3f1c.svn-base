...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__216PIN__HK_M_RT2785E06_1DP2HDMI1USB_LVDS.h No.0000
// Update Note  :
#if(_PCB_TYPE == _RL6432__216PIN__HK_M_RT2785E06_1DP2HDMI1USB_LVDS)
...
#define _INPUT_PORT_SEARCH_PRI_2                _D2_INPUT_PORT//_D1_INPUT_PORT
////////////////////
// For LVDS Panel //
////////////////////
...
#elif(_LVDS_CABLE_TYPE == _LVDS_CABLE_TYPE_2)
...
//#define _AUDIO_VOLUMN_PWM						_NO_PWM
...
#define _PIN_93                                 (3 & 0x0F) // Page 10-0x0E[2:0]
...
// DP33V_ON (NC)
#define  _PIN_183_OFF_REGION                                  (0 & 0x0F) // Page 10-0x28[2:0]
...
#define   OSD_LED_CONTRL(x)          (MCU_FE0B_PORT53_PIN_REG = x)//_PIN_174,   P5D1
#define   GET_LED_STATUS()          (MCU_FE0B_PORT53_PIN_REG)
...
//-----------------------------------------------
#define bVCCKOFFPOWER                           (MCU_FE20_PORT80_PIN_REG) // _PIN_198, P8.0
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE14_PORT64_PIN_REG) // _PIN_172, P6D4
...
//--------------------------------------------------
#define bPANELPOWER                           (MCU_FE12_PORT62_PIN_REG) // _PIN_170_OFF_REGION,P6D2
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE1F_PORT77_PIN_REG) // _PIN_197_OFF_REGION,P7D7
...
#define bD1_CONNECT                    (P1_4)                 // Pin_53, P1.3

#define bD2_CONNECT                    (MCU_FE30_PORTA0_PIN_REG) // _Pin_216    ,PAD0
sbit bD3_CONNECT                       = P1 ^ 0;                 // _PIN_1,  P1.0
...
//-----------------------------------------------
#define GET_PCB_D0_DP_SOURCE_POWER()            (bD0_CONNECT)

//-----------------------------------------------
// Macro of MHL Cable Connect
//-----------------------------------------------
//sbit bD2_MHL_CONNECT                            = P3 ^ 7; // Pin_94, P3.7
//sbit bD3_MHL_CONNECT                            = P3 ^ 6; // Pin_93, P3.6
...
//-----------------------------------------------
#define bD0_HPD                                    (MCU_FE22_PORT82_PIN_REG) // _Pin_201, P8.2
#define bD1_HPD 								(MCU_FE27_PORT87_PIN_REG) // _Pin_205, P8.7
sbit bD2_HPD                                    = P1 ^ 2; // _Pin_15, P1.2
sbit bD3_HPD                                    = P1 ^ 1; // _PIN_3, P1.1
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                      (MCU_FE47_PORTC7_PIN_REG ) // _PIN_97,  PCD7
#define bLED2                                      (MCU_FE48_PORTD0_PIN_REG) // _PIN_98 ,  PDD0
...
#define AD_KEY1                                (MCU_FF09_ADC_A0_CONVERT_RESULT) // _PIN_91
#define AD_KEY2                                (MCU_FF0A_ADC_A1_CONVERT_RESULT) // _PIN_92
#define AD_KEY3                                (MCU_FF0B_ADC_A2_CONVERT_RESULT) // _PIN_92
...
#define RIGHT_KEY								0x80//0xa8
    
#define POWER_REG								1
#define MENU_REG								3
#define EXIT_REG								2
#define LEFT_REG								2
#define RIGHT_REG								2//3
    
#endif


#define KEY_SWITCT(x)           (KeyDefault[x] == 3?AD_KEY3:(KeyDefault[x] == 2?AD_KEY2:(AD_KEY1)))


#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= KEY_SWITCT(9)) && (KEY_SWITCT(9) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
                                                                }\
                                                                if((((KeyDefault[3]<10)? 0: KeyDefault[3]-10) <= KEY_SWITCT(8)) && (KEY_SWITCT(8) < ((KeyDefault[3]>237)? 247: KeyDefault[3]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _RIGHT_KEY_MASK ;\
                                                                }\                                                             
                                                                if((((KeyDefault[2]<10)? 0: KeyDefault[2]-10) <= KEY_SWITCT(7)) && (KEY_SWITCT(7) < ((KeyDefault[2]>237)? 247: KeyDefault[2]+10)))\
                                                                {\
																	(ucKeyState) |= _EXIT_KEY_MASK ;\
                                                                }\                                                 
                                                                if((((KeyDefault[1]<10)? 0: KeyDefault[1]-10) <= KEY_SWITCT(6)) && (KEY_SWITCT(6) < ((KeyDefault[1]>237)? 247: KeyDefault[1]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _MENU_KEY_MASK ;\
                                                                }\
                                                                if((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= KEY_SWITCT(5)) && (KEY_SWITCT(5) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10)))\
                                                                {\
...
#define AD_KEY1                               (MCU_FF09_ADC_A0_CONVERT_RESULT) // _PIN_91
#define AD_KEY2                                (MCU_FF0A_ADC_A1_CONVERT_RESULT) // _PIN_92
#define AD_KEY3                                (MCU_FF0B_ADC_A2_CONVERT_RESULT) // _PIN_93
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0xc0<= (ucV3)) && ((ucV3) < 0xe0))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
                                                                }\
                                                                if((0x98 <= (ucV3)) && ((ucV3) < 0xb8))\
                                                                {\
                                                                    (ucKeyState) |= _RIGHT_KEY_MASK ;\
                                                                }\
                                                                if((0x70 <= (ucV3)) && ((ucV3) < 0x90))\
                                                                {\
                                                                    (ucKeyState) |=_EXIT_KEY_MASK ;\
                                                                }\
...
//-----------------------------------------------
//#define bHeadphoneDetect                        (_HEADPHONE_CONNECT) 
sbit bHeadphoneDetect                                    = P3 ^ 7; //_PIN_94,P3D7
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE11_PORT61_PIN_REG) //_PIN_169_OFF_REGION, P6D1
...
#if 0//(_PWM_DUT_RESOLUTION == _PWM_8BIT)
...
#if(Project_ID == ID_HUIXIONG_HK2785E06_MV315QHM_N40_QHD90HZ_10BIT_EDID_X322Q90_20230713)
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,__,_COLON__,__,_X__,_3__,_2__,_2__,_Q__,_9__,_0__
#else
#define _MAIN_PAGE_MODEL_NAME                _S__,_c__,_a__,_l__,_e__,_r__,__ ,_COLON__,__ ,_R__,_T__,_D__,_2__,_7__,_8__,_5__
#endif

#if 1
#define _BURNIN_STR_IC_NAME                	_B__,_o__,_a__,_r__,_d__,_COLON__,__,_H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_7__,_8__,_5__,_E__,_0__,_6__
#else
#define _BURNIN_STR_IC_NAME                	 _S__,_c__,_a__,_l__,_e__,_r__,__ ,_COLON__,__ , _R__,_T__,_D__,_2__,_7__,_8__,_5__
#endif
...
#define PCB_MPRT_TCON_PIN_SHARE_CONFIG(x)       {\
													if(x == _ON)\
													{\
														ScalerSetByte(0x102F, (BYTE)(5));\
													}\
													else\
													{\
														ScalerSetByte(0x102F, (BYTE)(1));\
													}\
												}
...
#endif // End of #if(_PCB_TYPE == _RL6432__216PIN__HK_M_RT2785E06_1DP2HDMI1USB_LVDS)
//----------------------------------------------------------------------------------------------------
