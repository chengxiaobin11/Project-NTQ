...
void ScalerMDomainCheckDisplaySetting(void)
{
    ...
    if(GET_MEMORY_SELECT() != _FRAME_SYNC_LINE_BUFFER)
    {
        ...
        ucBWUseEfficiency += ulPathBwSum * 10 / _MEMORY_DATA_RATE_SPEED;
        DebugMessageCheckMDomain("FRC Efficiency(%)", (ulPathBwSum * 10 / _MEMORY_DATA_RATE_SPEED));
        DebugMessageCheckMDomain("FRC RemainBW(%)", _MEMORY_EFFICIENCY - ucBWUseEfficiency);
