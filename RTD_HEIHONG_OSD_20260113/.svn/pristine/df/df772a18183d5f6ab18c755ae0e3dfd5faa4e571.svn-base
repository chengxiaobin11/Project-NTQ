...
#define GET_DP_TX_EDID_READ_SEGMENT()                               (g_punTxPortEdidReadPosition[0].pucData[0])
#define SET_DP_TX_EDID_READ_SEGMENT(x)                              (g_punTxPortEdidReadPosition[0].pucData[0] = (x))

#define GET_DP_TX_EDID_READ_OFFSET()                                (g_punTxPortEdidReadPosition[0].pucData[1])
#define SET_DP_TX_EDID_READ_OFFSET(x)                               (g_punTxPortEdidReadPosition[0].pucData[1] = (x))


#define GET_DP_TX_EDID_READ_POSITION()                              (\
                                                                        TO_WORD(\
                                                                            g_punTxPortEdidReadPosition[0].pucData[0],\
                                                                            g_punTxPortEdidReadPosition[0].pucData[1])\
                                                                    )
#define SET_DP_TX_EDID_READ_POSITION(x)                             {\
                                                                        g_punTxPortEdidReadPosition[0].pucData[0] = HIBYTE(x);\
                                                                        g_punTxPortEdidReadPosition[0].pucData[1] = LOBYTE(x);\
                                                                    }

#define INC_DP_TX_EDID_READ_POSITION(x)                             {\
                                                                        WORD usLocalDpTxEdidPosition = GET_DP_TX_EDID_READ_POSITION() + (x);\
                                                                        SET_DP_TX_EDID_READ_POSITION(usLocalDpTxEdidPosition);\
                                                                    }

#define CLR_DP_TX_EDID_READ_POSITION()                              {SET_DP_TX_EDID_READ_POSITION(0);}
