...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E11__1H1DP__LVDS)
...
#define _D0_EMBEDDED_DDCRAM_LOCATION           _EDID_TABLE_LOCATION_CODE// _EDID_TABLE_LOCATION_CODE
...
//  modiby henry by 20210812  DP 在120 144hz 闪屏
#define _D1_DP_LINK_CLK_RATE              _DP_HIGH_SPEED2_540MHZ//    _DP_HIGH_SPEED_270MHZ//  _DP_HIGH_SPEED2_540MHZ
...
//========================================
///////////////
#define _D3_TMDS_BR_SWAP                    _ON//    _OFF// HDMI
#define _D3_TMDS_PN_SWAP                    _ON//   _OFF// HDMI
...
#define _LVDS_PORT_SEL                   _LVDS_2_PORT_CD//     _LVDS_2_PORT_AB//  _LVDS_2_PORT_CD
...
#define _LVDS_DRIV_CONTROL        _LVDS_DRIV_CONTROL_2_0//       _LVDS_DRIV_CONTROL_3_0
#define _LVDS_VCM_CONTROL          _LVDS_VCM_NORMAL//     _LVDS_VCM_LOW//        _LVDS_VCM_NORMAL
...
// LVDS SSC Config
//--------------------------------------------------
#define _LVDS_SPREAD_RANGE     10// 15
...
//BY QS   TBD
//  注意如果背光PWM调用 5口时，_AUDIO_VOLUMN_PWM 不能设为_NO_PWM, 否则_AUDIO_VOLUMN_PWM也会同时调用到背光PWM 5
#define _BACKLIGHT_PWM                          _PWM5
#define _BACKLIGHT_PWM_INVERSE                  _OFF
...
// DP_CABLE_DET_0
#define _156PIN_PIN_84                          (0 & 0x0F) // Page 10-0x01[2:0]
...
// HDMI_HPD_2
#define _156PIN_PIN_69                          (2& 0x0F) // Page 10-0x33[2:0]
...
#define PCB_ON_REGION_GPIO_SETTING_POWER_AC_ON(){\
	PCB_VCCK_HUB_POWER(_VCCK_HUB_POWER_ON);\
                                                }
...
#define PCB_GPIO_SETTING_POWER_DOWN()           {\
	PCB_VCCK_HUB_POWER(_VCCK_HUB_POWER_OFF);\
}



#define _VCCK_HUB_POWER_ON                      1
#define _VCCK_HUB_POWER_OFF                     0


#define VCCK_HUB_EN        (MCU_FE2A_PORT92_PIN_REG) //    _156PIN_PIN_77   ,  P9D2


#define PCB_VCCK_HUB_POWER(x)                   {\
                                                    VCCK_HUB_EN = (x);\
												}
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE1F_PORT77_PIN_REG) // _156PIN_PIN_66, P7.7
...
/*
//EEPROM
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_210, P9.2
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_211, P9.3


//HDMI1
#define  bDDC1IICSCL         				    	      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//      =P3^2; // _PIN_73, 
#define  bDDC1IICSDA          					      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)// =P3^3; // _PIN_74,


//HDMI2
#define bDDC2IICSCL         				    	      (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_212, 
#define bDDC2IICSDA          					      (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_213,


//HDMI3
#define bDDC3IICSCL         				    	      (MCU_FE2E_PORT96_PIN_REG) // _PIN_214, 
#define bDDC3IICSDA          					      (MCU_FE2F_PORT97_PIN_REG) // _PIN_215,
...
//-----------------------------------------------
#define bD1_DP_PIN15_CONNECT                    (MCU_FE25_PORT85_PIN_REG) // _156PIN_PIN_72, P8.5  ,DP_SINK_ASS_P1
sbit bD1_DP_PIN16_CONNECT                       = P1 ^ 3; // 156PIN_PIN_118, P1.3
#define bD1_DP_PIN17_CONNECT                    (MCU_FE24_PORT84_PIN_REG) // _156PIN_PIN_71, P8.4  ,DP_SINK_ASS_N1
...
sbit bD3_CONNECT                             	= P1 ^ 4; // _156PIN_PIN_119,  P1D4 ,HDMI_CABLE_DETECT_2
...
//-----------------------------------------------
#define bD1_HPD                                 (MCU_FE22_PORT82_PIN_REG) // _156PIN_PIN_70, P8.2
#define bD3_HPD                                 (MCU_FE23_PORT83_PIN_REG) // 156PIN_PIN_69, P8.3   HDMI_HPD_2
...
#define bLED1                                   (MCU_FE27_PORT87_PIN_REG) // _156PIN_PIN_74,P8D7
#define bLED2                                   (MCU_FE26_PORT86_PIN_REG) // _156PIN_PIN_73, P8D6
...
#define _MAIN_PAGE_MODEL_NAME                 _M_,_o__,_d__,_e__,_l__,_,_COLON__,_,_2_,_5_,_5_,_6_,_Q_,_R_
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_6__,_E__,_1__,_1__
