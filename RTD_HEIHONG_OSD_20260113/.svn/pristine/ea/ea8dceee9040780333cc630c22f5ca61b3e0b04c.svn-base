...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6851_Series_ScalerVGATopInclude.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
//--------------------------------------------------
#define GET_THERMO_LONG_PATH_STATUS()                   (ScalerGetBit(P1_B1_PLLDIV_H, _BIT5) == _BIT5)
#define SET_THERMO_LONG_PATH_STATUS()                   (ScalerSetBit(P1_B1_PLLDIV_H, ~_BIT5, _BIT5))
#define CLR_THERMO_LONG_PATH_STATUS()                   (ScalerSetBit(P1_B1_PLLDIV_H, ~_BIT5, 0x00))
