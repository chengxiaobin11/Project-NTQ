...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449_SG95TC_HTP_WS_R10_1_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__SG95TC_HTP_WS_R10_1_DPTX_eDP)
///////////////////
// External Xtal //
///////////////////
...
#define bPCB24TO12CONTROL                     (MCU_FE21_PORT81_PIN_REG) // _PIN_179 P8.1  

#define _24VTO12V_ON                            1       
#define _24VTO12V_OFF                           0       

#define PCB_24VT012V_ON(x)                         {\
                                                    bPCB24TO12CONTROL = x; \
                                             }
...
sbit bUSBPOWER                       = P3 ^ 5; //  156PIN_PIN_91, P3.5
...
#define GET_PCB_USB_POWER()                 (bUSBPOWER)


//usb_hub_en
sbit bUSB_HUB_EN                     = P3 ^ 0; // 156PIN_PIN_71, P3.0
//#define bUSB_HUB_EN                           (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
...
//-----------------------------------------------
#define bDDRPOWER                               (P3_6) // Pin_92, P3.6
...
//--------------------------------------------------
#define bPANELPOWER                             (MCU_FE1A_PORT72_PIN_REG) // Pin_159, P7.2
...
#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _LOW) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
...
#define bLED1                                   (MCU_FE2D_PORT95_PIN_REG) // Pin_199, P9.5
#define bLED2                                   (MCU_FE2E_PORT96_PIN_REG) // Pin_200, P9.6
...
#define  bPOWER_KEY                              (MCU_FE36_PORTA6_PIN_REG)// Pin_209 PA.6
...
#define bHeadphoneDetect                           (MCU_FE05_PORT45_PIN_REG)//Pin_113 P4.5
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE1C_PORT74_PIN_REG) //  _PIN_160 P7.3 
...
#define _MAIN_PAGE_MODEL_NAME                   _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_7_,_9_,_5_,_U_,_T_
#define _BURNIN_STR_IC_NAME                	    _R_,_T_,_D_,_2_,_7_,_9_,_5_,_U_,_T_


#endif // End of #if(_PCB_TYPE == _RL6449_SG95TC_HTP_WS_R10_1_DPTX_eDP)
