...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432_SG_C_156PIN_1A1H_FFC_DPTX_eDP.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432_SG_C_156PIN_1A1H_FFC_DPTX_eDP)
...
#define bDDRPOWER                               (MCU_FE1F_PORT77_PIN_REG) // _PIN_66, P7.7
...
#if 0//(_CUSTOMER_TYPE == _YSD_CUSTOMER)
...
#elif 0//(_OSD_TYPE == _HKC_OSD)&&(_CUSTOMER_TYPE == _DJEX_CUSTOMER)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0 <= (ucV2)) && ((ucV2) < 0x50))\
                                                                {\
                                                                    (ucKeyState) |= _EXIT_KEY_MASK;\
...
#elif 0//(_CUSTOMER_TYPE == _PZG_CUSTOMER)//170731
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0 <= (ucV2)) && ((ucV2) < 0x50))\
                                                                {\
                                                                    (ucKeyState) |= _EXIT_KEY_MASK;\
...
//-----------------------------------------------
#if  1//(_AUDIO_HEADPHONE_SUPPORT==_ON)
sbit bHeadphoneDetect                           = P3 ^ 1;//Pin136
#if 1// (_WS_PCB==_ON)
...
#define _MAIN_PAGE_MODEL_NAME                   _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_5_,_5_,_0_
#define _BURNIN_STR_IC_NAME                	    _R_,_T_,_D_,_2_,_5_,_5_,_0_



#endif // End of #if(_PCB_TYPE == _RL6432_SG_C_156PIN_1A1H_FFC_DPTX_eDP)
