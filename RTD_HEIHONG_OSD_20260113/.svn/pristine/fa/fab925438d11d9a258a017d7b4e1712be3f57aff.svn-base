...
void ExternalDeviceInterfaceTypeCPmicACOnInitial(void)
{
    ...
    // Clear INT Flag
    ScalerTypeCPmicIICRead(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY8665_STATE_REG, _SY8665_SUBADDR_LENGTH, 1, (BYTE *)(&g_stPMICData) + _SY8665_STATE_REG);
}
...
void ExternalDeviceInterfaceTypeCPmicUnattachReset_EXINT0(void) using 1
{
    ...
    // Initial Pmic Value
    ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY8665_FUNCTION_SETTING1, _SY8665_SUBADDR_LENGTH, 5, (BYTE *)(&g_stPMICData) + _SY8665_FUNCTION_SETTING1);

    // Clear INT Flag
    ScalerTypeCPmicIICRead_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY8665_STATE_REG, _SY8665_SUBADDR_LENGTH, 1, (BYTE *)(&g_stPMICData) + _SY8665_STATE_REG);
}
