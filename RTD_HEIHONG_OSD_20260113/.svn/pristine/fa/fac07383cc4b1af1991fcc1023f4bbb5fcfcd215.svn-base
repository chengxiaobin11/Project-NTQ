...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__RTD2556T_1A1D_LS_R30_1__1A1DVI__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#if(_PCB_TYPE == _RL6432__156PIN__RTD2556T_1A1D_LS_R30_1__1A1DVI__LVDS)
...
//#define _PORT_NAME_STR_D0						_STR_INDEX_NULL
#else //for test
//--------------------------------------------------
...
#define _PORT_NAME_STR_D0						_STR_INDEX_DP
...
//#define _PORT_NAME_STR_D1						_STR_INDEX_HDMI1
...
//#define _PORT_NAME_STR_D3						_STR_INDEX_NULL
...
//--------------------------------------------------
//#define _A0_INPUT_PORT_GROUP                    _INPUT_PORT_GROUP_2
...
// LVDS Port Config
//--------------------------------------------------
//#define _LVDS_CABLE_TYPE                       0//_PANEL_LVDS_CABLE_TYPE
...
//--------------------------------------------------
#define _PANEL_DPTX_1_1_SPREAD_RANGE            3
...
// HDMI_HPD_2
#define _156PIN_PIN_118                         (2 & 0x0F) // Page 10-0x03[2:0]
...
// Speaker_EN
#define _156PIN_PIN_136                         (2 & 0x0F) // Page 10-0x09[2:0]
...
// NC
#define _156PIN_PIN_49_OFF_REGION               (0 & 0x0F) // Page 10-0x24[2:0]
...
// adj
#define _156PIN_PIN_68                          (4 & 0x0F) // Page 10-0x31[2:0]
...
// DDR_PWR
#define _156PIN_PIN_71                          (2 & 0x0F) // Page 10-0x34[2:0]
...
#define bDDRPOWER                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_71, P8.4
...
#if 0//(_RTD2556_eDP_WS_R10_1_TYPE == _ON)
...
//--------------------------------------------------
#define bBACKLIGHTPOWER                         (MCU_FE1C_PORT74_PIN_REG) // 156PIN_PIN_67, P8.0
...
#define bD0_DP_PIN16_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_118, P1.3
...
#define bD1_HDMI_PIN11_CONNECT                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // 156PIN_PIN_119, P1.4
#define bD1_DP_PIN17_CONNECT                    (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_73, P8.6

#define bA0_CONNECT                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_133, P1.7
#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
//sbit bD1_CONNECT                              = P1 ^ 0; // 156PIN_PIN_82, P1.0
sbit bD1_CONNECT                                = P1 ^ 4; // 156PIN_PIN_119, P1.4
...
//-----------------------------------------------
#define bD3_MHL_CONNECT                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  // 156PIN_PIN_65 , P7.5

#define PCB_D3_MHL_DETECT()                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS)

#define bD3_MHL_VBUS_SWITCH                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_63, P7.2
...
#define bD1_HPD                                MCU_FE23_PORT83_PIN_REG // 156PIN_PIN_118, P1.3
...
//-----------------------------------------------
#define bD3_TMDS_SWITCH                         (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_64, P7.4
...
//--------------------------------------------------
#define bLVDSDPTXSWICH                          (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // 156PIN_PIN_48, P6.3
...
// Macro of LED On/Off
//--------------------------------------------------
#define bLED1                                   (MCU_FE26_PORT86_PIN_REG) // 156PIN_PIN_151, P4.4
#define bLED2                                   (MCU_FE27_PORT87_PIN_REG) // 156PIN_PIN_152, P4.5
...
#if 0//(_CUSTOMER_TYPE == _SUNSHINE_CUSTOMER)
...
#define bPOWER_KEY                              (MCU_FE05_PORT45_PIN_REG) // _156PIN_PIN_76, P9.1
...
//#if  (_AUDIO_HEADPHONE_SUPPORT==_ON)
  ...
  sbit bHeadphoneDetect							= P1 ^ 6;//Pin132
  sbit bHeadphoneDetect1                         = P1 ^ 5;//Pin131
  #define HeadPhone_1
  #if 1//(_WS_PCB==_ON)
  ...
  #define PCB_HEADPHONE_DETECT_1() 				  (bHeadphoneDetect1)

  #elif 1//for test
  sbit bHeadphoneDetect							= P1 ^ 5;//Pin132  
  //#define HeadPhone_1
  #if 1//(_WS_PCB==_ON)
  #define _HEADPHONE_CONNECT                     1
  #define _HEADPHONE_DISCONNECT                  0  
  ...
  sbit bHeadphoneDetect                           = P1 ^ 5;//Pin131
  sbit bHeadphoneDetect1							= P1 ^ 6;//Pin132
  #define HeadPhone_1
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                       (MCU_FE1D_PORT75_PIN_REG)//Pin133
#if 1
...
#define _MAIN_PAGE_MODEL_NAME                   _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_5_,_5_,_6_
#define _BURNIN_STR_IC_NAME                	    _R_,_T_,_D_,_2_,_5_,_5_,_6_



#endif // End of #if(_PCB_TYPE == _RL6432_SG_C_156PIN_1A1H_DPTX_eDP)
