...
#define _ADDR_03_VOUT_OVP_SETTING           0x02        // 120%
...
void ExternalDeviceInterfaceTypeCPmicACOnInitial(void)
{
    ...
    // Clear INT Flag
    ScalerTypeCPmicIICRead(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9228_STATE_REG, _SY9228_SUBADDR_LENGTH, 2, (BYTE *)(&g_stPMICData) + _SY9228_STATE_REG);
}
...
void ExternalDeviceInterfaceTypeCPmicUnattachReset_EXINT0(void) using 1
{
    ...
    // Initial Pmic Value
    ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9228_FUNCTION_SETTING1, _SY9228_SUBADDR_LENGTH, 5, (BYTE *)(&g_stPMICData) + _SY9228_FUNCTION_SETTING1);

    // Clear INT Flag
    ScalerTypeCPmicIICRead_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9228_STATE_REG, _SY9228_SUBADDR_LENGTH, 2, (BYTE *)(&g_stPMICData) + _SY9228_STATE_REG);
}
