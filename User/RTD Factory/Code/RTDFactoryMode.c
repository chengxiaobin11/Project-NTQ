...
#if(_DEF_CT_JX)
//============= Colortemp 7 R=======================
void RTDFactoryColortemp7REnter(void);
void RTDFactoryColortemp7RLeft(void);
void RTDFactoryColortemp7RRight(void);
void RTDFactoryColortemp7RExit(void);
//============= Colortemp 7 G=======================
void RTDFactoryColortemp7GEnter(void);
void RTDFactoryColortemp7GLeft(void);
void RTDFactoryColortemp7GRight(void);
void RTDFactoryColortemp7GExit(void);
//============= Colortemp 7 B=======================
void RTDFactoryColortemp7BEnter(void);
void RTDFactoryColortemp7BLeft(void);
void RTDFactoryColortemp7BRight(void);
void RTDFactoryColortemp7BExit(void);

//============= Colortemp 7 R Adjust=======================
void RTDFactoryColortemp7RAdjustEnter(void);
void RTDFactoryColortemp7RAdjustLeft(void);
void RTDFactoryColortemp7RAdjustRight(void);
void RTDFactoryColortemp7RAdjustExit(void);
//============= Colortemp 7 G Adjust=======================
void RTDFactoryColortemp7GAdjustEnter(void);
void RTDFactoryColortemp7GAdjustLeft(void);
void RTDFactoryColortemp7GAdjustRight(void);
void RTDFactoryColortemp7GAdjustExit(void);
//============= Colortemp 7 B Adjust=======================
void RTDFactoryColortemp7BAdjustEnter(void);
void RTDFactoryColortemp7BAdjustLeft(void);
void RTDFactoryColortemp7BAdjustRight(void);
void RTDFactoryColortemp7BAdjustExit(void);
#endif
...
code void (*OperationFactoryTable[][4])(void) =
{
...
#if(_DEF_CT_JX)
	{RTDFactoryColortemp7REnter,					RTDFactoryColortemp7RLeft,						RTDFactoryColortemp7RRight, 					RTDFactoryColortemp7RExit,},
	{RTDFactoryColortemp7GEnter,					RTDFactoryColortemp7GLeft,						RTDFactoryColortemp7GRight, 					RTDFactoryColortemp7GExit,},
	{RTDFactoryColortemp7BEnter,					RTDFactoryColortemp7BLeft,						RTDFactoryColortemp7BRight, 					RTDFactoryColortemp7BExit,},
#endif
	...
	{RTDFactoryBurnAudioTestEnter,					RTDFactoryBurnAudioTestLeft,		 			RTDFactoryBurnAudioTestRight,					RTDFactoryBurnAudioTestExit,},
...
#if(_DEF_CT_JX)
	{RTDFactoryColortemp7RAdjustEnter,				RTDFactoryColortemp7RAdjustLeft,				RTDFactoryColortemp7RAdjustRight,				RTDFactoryColortemp7RAdjustExit,},
	{RTDFactoryColortemp7GAdjustEnter,				RTDFactoryColortemp7GAdjustLeft,				RTDFactoryColortemp7GAdjustRight,				RTDFactoryColortemp7GAdjustExit,},
	{RTDFactoryColortemp7BAdjustEnter,				RTDFactoryColortemp7BAdjustLeft,				RTDFactoryColortemp7BAdjustRight,				RTDFactoryColortemp7BAdjustExit,},
#endif
    ...
    {RTDFactoryLogoOnOffEnter,                      RTDFactoryLogoOnOffRight,                       RTDFactoryLogoOnOffLeft,                        RTDFactoryLogoOnOffExit,},
    
    {RTDFactoryBurnAudioTestAdjustEnter,            RTDFactoryBurnAudioTestAdjustLeft,              RTDFactoryBurnAudioTestAdjustRight,             RTDFactoryBurnAudioTestAdjustExit,},
};
...
void RTDFactoryMenuOperation(void)
{
       ...
       (GET_KEYMESSAGE() < _KEY_AMOUNT))
    {
        ...
        (*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][_LEFT_KEY_MESSAGE])();
		else if(GET_KEYMESSAGE()==_LEFT_KEY_MESSAGE)
			(*OperationFactoryTable[GET_OSD_STATE() - _MENU_FACTORY_AUTOCOLOR][_RIGHT_KEY_MESSAGE])();
		else
...
bit IS_HDCP_KEY_READY(void)
{   
    BYTE pucReadArray[8] = {0};
#if(_HDCP_2_2_KEY_LOCATION == _TABLE_LOCATION_FLASH)	
    UserCommonFlashRead(_RX_HDCP_2_2_KEY_FLASH_BANK, _RX_HDCP_2_2_KEY_ADDRESS_FLASH+0x45F-6, 8, pucReadArray);
#elif(_HDCP_1_4_KEY_LOCATION == _TABLE_LOCATION_FLASH)
    UserCommonFlashRead(_RX_HDCP_1_4_KEY_FLASH_BANK, _RX_HDCP_1_4_KEY_ADDRESS_FLASH +375-6 , 8, pucReadArray);
#else
    return 0;
#endif

//	if((pucReadArray[0] == 0xff)&&(pucReadArray[1] == 0xff)&&(pucReadArray[2] == 0xff)&&(pucReadArray[3] == 0xff)&&(pucReadArray[4] == 0xff)&&(pucReadArray[5] == 0xff)&&(pucReadArray[6] == 0xff)&&(pucReadArray[7] == 0xff))
    DebugMessageOsd("pucReadArray[7]", pucReadArray[7]);
    DebugMessageOsd("pucReadArray[6]", pucReadArray[6]);
	if((pucReadArray[6] != 0xff)&&(pucReadArray[7] == 0XFF))
    {
        return 1;
    }
   else
...
void RTDFactoryMainMenu(void)
{
	...
	ScalerOsdMapRotation(GET_OSD_ROTATE_STATUS(), _ENABLE, HEIGHT(_FACTORY_OSD_ROW), _DISABLE, 0, _ENABLE);
#endif
    ...
    RTDFactoryOsdFuncClearOsdFont(0, 0, _FACTORY_OSD_COL, _FACTORY_OSD_ROW, 0x00);
...
#if 1
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW), COL(_FACTORY_FUNCTION_COL+13), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[1], _ENGLISH);
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW+1), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_BURNIN_PAGE_TABLE[0], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW+2), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[2], _ENGLISH);
#if(_VGA_SUPPORT == _ON)
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[3], _ENGLISH);
#endif
#else
	...
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_MODEL_NAME_ROW+1), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[2], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[3], _ENGLISH);
#endif
	...
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_ADC_GAIN_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[23], _ENGLISH);
#else
...
//    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP6_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[15], _ENGLISH);
  ...
  //  RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_OSD_PAGE_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[18], _ENGLISH);
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_OSD_PAGE_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[22], _ENGLISH);
  	#endif
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[21], _ENGLISH);
#if _HDCP_KEY_WIRTE_FLAG

//HDCP_KEY
//    if(IS_HDCP_KEY_READY())
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW-1), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_ITEM_30, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[23], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW-1), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_PAGE_ITEM_29, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PASS_FAIL_TABLE[IS_HDCP_KEY_READY()], _ENGLISH);
    RTDFactoryOsdFuncChangeColor1Bit(ROW(_FACTORY_LOGO_ROW-1), COL(_FACTORY_ON_OFF_COL), 4, 1, COLOR(((IS_HDCP_KEY_READY()== _ON) ? (_CP_GREEN) : (_CP_RED)), _CP_BG));
#endif
...
#if(Project_ID == ID_CHUANGHONG_HK2556E01_1P1H_M270HAN02_6_FHD165HZ_20210816)
	for(ucRowCount = 0; ucRowCount <= _CT_6500; ucRowCount++)
#elif(_DEF_CT_JX)
	for(ucRowCount = 0; ucRowCount <= _CT_8000-1; ucRowCount++)
#else
...
#endif
    {
#if(_DEF_CT_JX)
    	if(ucRowCount == 0)
        	RTDNVRamLoadColorSetting(_CT_9300);
		else if(ucRowCount == 1)
        	RTDNVRamLoadColorSetting(_CT_8000);
		else if(ucRowCount == 2)
        	RTDNVRamLoadColorSetting(_CT_7500);
		else if(ucRowCount == 3)
        	RTDNVRamLoadColorSetting(_CT_7000);
		else if(ucRowCount == 4)
        	RTDNVRamLoadColorSetting(_CT_6500);
		else if(ucRowCount == 5)
        	RTDNVRamLoadColorSetting(_CT_5800);
		else if(ucRowCount == 6)
        ...
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_R_NUMBER_COL),GET_COLOR_TEMP_TYPE_USER_R(), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_R + ucRowCount * 3);
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_G_NUMBER_COL), GET_COLOR_TEMP_TYPE_USER_G(), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_G + ucRowCount * 3);
        RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_B_NUMBER_COL), GET_COLOR_TEMP_TYPE_USER_B(), (_ALIGN_RIGHT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_COLORTEMP1_B + ucRowCount * 3);
    }
...
*/
...
#if(_VGA_SUPPORT == _ON)
     RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_AUTO_COLOR, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PASS_FAIL_TABLE[GET_OSD_ALIGN_MODE()], _ENGLISH);
     RTDFactoryOsdFuncChangeColor1Bit(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_FACTORY_ON_OFF_COL), 4, 1, COLOR(((GET_OSD_ALIGN_MODE()== _ON) ? (_CP_GREEN) : (_CP_RED)), _CP_BG));
#endif

#endif
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_AUTOCOLOR_ROW), COL(_AUTO_COLOR_ROW), _PFONT_FACTORY_AUTO_COLOR, tFONT_FACTORY_EUROPE, tOSD_FACTORY_AUTO_COLOR_TYPE_TABLE[GET_OSD_OCC_RLT_TYPE()], _ENGLISH);

    // Burnin on or off
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BURNIN_ROW), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_BURNIN, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_OSD_BURNING_MODE()], _ENGLISH);
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_LOGO_ROW), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_LOGO_TYPE, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_OSD_LOGO()], _ENGLISH);
    ...
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BURNIN_TIME_ROW), COL(_FACTORY_BURNIN_TIME_HOUR_NUMBER_COL), GET_PANEL_BURN_TIME_HOUR(), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_5), _PFONT_FACTORY_BURNIN_TIME_HOUR);
    RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BURNIN_TIME_ROW), COL(_FACTORY_BURNIN_TIME_MIN_NUMBER_COL), GET_PANEL_BURN_TIME_MIN(), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_BURNIN_TIME_MIN);
...
#endif
	//RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_EXIT_ROW+1),COL(5),_PFONT_FACTORY_PAGE_1,tFONT_FACTORY_EUROPE, tOSD_BURNIN_PAGE_TABLE[_FACTORY_CHKSUM], _ENGLISH);
	RTDFactoryOsdFuncShowChecksum(ROW(_FACTORY_EXIT_ROW+1), COL(20), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_5), _PFONT_FACTORY_PAGE_1);
...
void RTDFactoryBurninEnter(void)
{
    g_usAdjustValue = GET_OSD_BURNING_MODE();
...
#if(_DEF_CT_JX)
	RTDFactoryOsdChangColorTemp(_CT_8000);
#else
...
#if(_DEF_CT_JX)
        RTDFactoryOsdChangColorTemp(_CT_7000);
#else
...
void RTDFactoryColortemp6BLeft(void)
{
    ...
    RTDFactoryOsdChangColorTemp(_CT_9300);
#elif(_DEF_CT_JX)
	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_RED);
	RTDFactoryOsdChangColorTemp(_CT_USER);

#elif(_INTERNAL_AUDIO_TEST_SUPPORT)

	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BURN_AUDIO_TEST);
...
{
    g_usBackupValue = g_stColorProcData.usColorTempR;
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_RED_ADJ);
}

void RTDFactoryColortemp7RLeft(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_GREEN);
}
...
{
    g_usBackupValue = g_stColorProcData.usColorTempG;
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_GREEN_ADJ);
}

void RTDFactoryColortemp7GLeft(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_BLUE);
}
...
{
    g_usBackupValue = g_stColorProcData.usColorTempB;
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_BLUE_ADJ);
}
...
void RTDFactoryColortemp7RAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT7_RED_ADJ, g_stColorProcData.usColorTempR);
}
...
void RTDFactoryColortemp7GAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT7_GREEN_ADJ, g_stColorProcData.usColorTempG);
}
...
void RTDFactoryColortemp7BAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_CT7_BLUE_ADJ, g_stColorProcData.usColorTempB);
}
...
{
   g_usAdjustValue = GET_OSD_LOGO();

  RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_LOGO_ON_OFF);
}

void RTDFactoryLogoLeft(void)//�����ƶ�
{
        RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_EXIT);
}

void RTDFactoryLogoRight(void)//�����ƶ�
{
#if(_DEF_CT_JX)
	RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT7_BLUE);
	RTDFactoryOsdChangColorTemp(_CT_USER);	
...
void RTDFactoryBurnAudioTestEnter(void)
{
   g_usAdjustValue = GET_BURNING_AUDIO_TEST();

  RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BURN_AUDIO_TEST_ADJ);
}

void RTDFactoryBurnAudioTestLeft(void)//�����ƶ�
{
...
void RTDFactoryBurnAudioTestRight(void)//�����ƶ�
{
  RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_CT6_BLUE);
  RTDFactoryOsdChangColorTemp(_CT_USER);
}

void RTDFactoryBurnAudioTestExit(void)
{
    RTDFactoryOsdFuncDisableOsd();
}
...
//============= Logo On Off=======================
void RTDFactoryLogoOnOffEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_LOGO);
}
...
void RTDFactoryLogoOnOffLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_LOGO_ON_OFF, g_usAdjustValue);
}

void RTDFactoryLogoOnOffRight(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_LOGO_ON_OFF, g_usAdjustValue);
}

void RTDFactoryLogoOnOffExit(void)
{
    RTDFactoryLogoOnOffEnter();
}

void RTDFactoryBurnAudioTestAdjustEnter(void)
{
    RTDFactoryOsdFuncSelectItem(_MENU_FACTORY_BURN_AUDIO_TEST);
}
...
void RTDFactoryBurnAudioTestAdjustLeft(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_BURN_AUDIO_TEST_ADJ, g_usAdjustValue);
}

void RTDFactoryBurnAudioTestAdjustRight(void)
{
    RTDFactoryOsdDispNumber(_MENU_FACTORY_BURN_AUDIO_TEST_ADJ, g_usAdjustValue);
}

void RTDFactoryBurnAudioTestAdjustExit(void)
{
RTDFactoryBurnAudioTestAdjustEnter();
