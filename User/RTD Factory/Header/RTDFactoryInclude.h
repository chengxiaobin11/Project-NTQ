...
#define _PFONT_FACTORY_LOGO_TYPE                    _PFONT_FACTORY_PAGE_ITEM_34
...
#define _FACTORY_PAGE_1_END                         0xF8
...
#define _FACTORY_ITEM_30_END                        (_FACTORY_ITEM_30_START + 10)
#define _FACTORY_ITEM_31_START                      (_FACTORY_ITEM_30_END)
#define _FACTORY_ITEM_31_END                        (_FACTORY_ITEM_31_START)
...
#define _FACTORY_AUTOCOLOR_ROW                      4
...
#define _FACTORY_LOGO_ROW                           20
#define _FACTORY_EXIT_ROW                           21
...
#define _FACTORY_ON_OFF_COL                         20//13
...
#define _BURNIN_EDID_YEAR_COL                   6
#define _BURNIN_EDID_WEEK_COL                   12
...
#define _BURNIN_PANEL_HDCP_ROW                  5

#define _BURNIN_TIME_ROW                        6
#define _AUTO_COLOR_ROW                         9

//EDID0
#define _BURNIN_EDID0_PORT_ROW                  _BURNIN_PANEL_HDCP_ROW+2
#define _BURNIN_EDID0_ID_NAME_ROW               _BURNIN_EDID0_PORT_ROW+1
#define _BURNIN_EDID0_SIZE_ROW                  _BURNIN_EDID0_ID_NAME_ROW+1
#define _BURNIN_EDID0_RESOLUT_ROW               _BURNIN_EDID0_SIZE_ROW+1
#define _BURNIN_EDID0_CSK_ROW               	_BURNIN_EDID0_RESOLUT_ROW+1
...
#define GetManufactNameC1(x)						((x==0)?(_X_):((((x)&0x7C00)>>10)+_A_-1))//BYTE8 bit6~bit2
#define GetManufactNameC2(x)						((x==0)?(_X_):((((x)&0x03E0)>>5)+_A_-1))//BYTE8 bit1~bit0 BYTE9 bit7~bit5
#define GetManufactNameC3(x)						((x==0)?(_X_):(((x)&0x001F)+_A_-1))//BYTE9 bit4~bit0


#define _EDID_WEEK_INDEX							0x10	
#define GetEDIDWeek0(x)								(((x)/10)+_0_)
#define GetEDIDWeek1(x)								(((x)%10)+_0_)


#define _EDID_YEAR_INDEX							0x11	
#define GetEDIDYear0(x)								(((1990+(x))/1000)+_0_)
#define GetEDIDYear1(x)								((((1990+(x))/100)%10)+_0_)
#define GetEDIDYear2(x)								((((1990+(x))/10)%10)+_0_)
#define GetEDIDYear3(x)								(((1990+(x))%10)+_0_)
...
//--------------------------------------------------
#if(_EDID_MESSAGE_SUPPROT==_OFF)//(_CUSTOM_TYPE == _FKX_CUSTOMER)

#if(_ALIGN_SUPPROT)
#define _BURNIN_OSD_ROW                      ((_BURNIN_PANEL_NAME_ROW)+3)//      ((_BURNIN_PANEL_NAME_ROW)+2)
#else
#define _BURNIN_OSD_ROW                       ((_BURNIN_PANEL_NAME_ROW)+2)
#endif


#define _BURNIN_OSD_COL                            18
...
#if(_DEF_HUIXIONG_BURN_MENU)
#define _BURNIN_OSD_ROW                            ((_BURNIN_PANEL_NAME_ROW)+((_EDID_PORT_NUM)*(EDID_ROW_NUM))+2+2)
#else
#define _BURNIN_OSD_ROW                            ((_BURNIN_PANEL_NAME_ROW)+((_EDID_PORT_NUM)*(EDID_ROW_NUM))+2+2)
#endif
...
#define _DDCRAM_D4		MCU_DDCRAM_D4
#define _ManValue_D4		((WORD)((_DDCRAM_D4[_EDID_MAN_NAME_INDEX0]<<8)|_DDCRAM_D4[_EDID_MAN_NAME_INDEX1]))
#endif
#if(((_D5_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)))
#define _DDCRAM_D5		MCU_DDCRAM_D5
#define _ManValue_D5		((WORD)((_DDCRAM_D5[_EDID_MAN_NAME_INDEX0]<<8)|_DDCRAM_D5[_EDID_MAN_NAME_INDEX1]))
#endif
#if(((_D6_EMBEDDED_DDCRAM_MAX_SIZE != _EDID_SIZE_NONE)))
#define _DDCRAM_D6		MCU_DDCRAM_D6
#define _ManValue_D6		((WORD)((_DDCRAM_D6[_EDID_MAN_NAME_INDEX0]<<8)|_DDCRAM_D6[_EDID_MAN_NAME_INDEX1]))
#endif
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
...
#if(_DEF_CT_JX)
	_MENU_FACTORY_CT7_RED,			_MENU_FACTORY_CT7_GREEN,		_MENU_FACTORY_CT7_BLUE,
#endif
...
#if(_DEF_CT_JX)
	_MENU_FACTORY_CT7_RED_ADJ,			_MENU_FACTORY_CT7_GREEN_ADJ,		_MENU_FACTORY_CT7_BLUE_ADJ,
#endif
    ...
    _MENU_FACTORY_LOGO_ON_OFF,
    _MENU_FACTORY_BURN_AUDIO_TEST_ADJ,
...
#if(_DEF_CT_JX)
//============= Colortemp 7 R=======================
extern void RTDFactoryColortemp7REnter(void);
extern void RTDFactoryColortemp7RLeft(void);
extern void RTDFactoryColortemp7RRight(void);
extern void RTDFactoryColortemp7RExit(void);
//============= Colortemp 7 G=======================
extern void RTDFactoryColortemp7GEnter(void);
extern void RTDFactoryColortemp7GLeft(void);
extern void RTDFactoryColortemp7GRight(void);
extern void RTDFactoryColortemp7GExit(void);
//============= Colortemp 7 B=======================
extern void RTDFactoryColortemp7BEnter(void);
extern void RTDFactoryColortemp7BLeft(void);
extern void RTDFactoryColortemp7BRight(void);
extern void RTDFactoryColortemp7BExit(void);

//============= Colortemp 7 R Adjust=======================
extern void RTDFactoryColortemp7RAdjustEnter(void);
extern void RTDFactoryColortemp7RAdjustLeft(void);
extern void RTDFactoryColortemp7RAdjustRight(void);
extern void RTDFactoryColortemp7RAdjustExit(void);
//============= Colortemp 7 G Adjust=======================
extern void RTDFactoryColortemp7GAdjustEnter(void);
extern void RTDFactoryColortemp7GAdjustLeft(void);
extern void RTDFactoryColortemp7GAdjustRight(void);
extern void RTDFactoryColortemp7GAdjustExit(void);
//============= Colortemp 7 B Adjust=======================
extern void RTDFactoryColortemp7BAdjustEnter(void);
extern void RTDFactoryColortemp7BAdjustLeft(void);
extern void RTDFactoryColortemp7BAdjustRight(void);
extern void RTDFactoryColortemp7BAdjustExit(void);
...
extern void RTDFactoryLogoEnter(void);
extern void RTDFactoryLogoLeft(void);
extern void RTDFactoryLogoRight(void);
extern void RTDFactoryLogoExit(void);



extern void RTDFactoryBurnAudioTestEnter(void);
extern void RTDFactoryBurnAudioTestLeft(void);
extern void RTDFactoryBurnAudioTestRight(void);
extern void RTDFactoryBurnAudioTestExit(void);
...
extern void RTDFactoryLogoOnOffEnter(void);
extern void RTDFactoryLogoOnOffLeft(void);
extern void RTDFactoryLogoOnOffRight(void);
extern void RTDFactoryLogoOnOffExit(void);


extern void RTDFactoryBurnAudioTestAdjustEnter(void);
extern void RTDFactoryBurnAudioTestAdjustLeft(void);
extern void RTDFactoryBurnAudioTestAdjustRight(void);
extern void RTDFactoryBurnAudioTestAdjustExit(void);
