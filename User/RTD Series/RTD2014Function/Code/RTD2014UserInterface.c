...
/********************************For Dcr*************************************/
	...
	BYTE code MPRTBacklightDefault[3] = 
	{
		_MPRT_PWM_MIN, 			
		_MPRT_PWM_DEF, 					   
		_MPRT_PWM_MAX, 
...
#if(_ADJ_BACKLIGHT_BY_TABLE == _ON)
	//For DCR :
    #if(_PANEL_TYPE == _AUO_P490QAR010_VBY_UHD_60HZ)
    WORD code tBacklight_Table[101] =
    {   
    ...
    #elif(_PANEL_TYPE == _AUO_P550QVR010_VBY_UHD_60HZ)
    WORD code tBacklight_Table[101] =
    {   
        ...
        145, 150, 156, 161, 166, 171, 176, 181, 186, 191,
        196, 202, 207, 212, 217, 222, 227, 232, 237, 243,
        248, 253, 258, 263, 268, 273, 278, 283, 289, 294,
        299, 304, 309, 314, 319, 324, 330, 335, 340, 345,
        350
    };
    #elif(_PANEL_TYPE == _AUO_P430QVR010_VBY_UHD_60HZ)
    WORD code tBacklight_Table[101] =
    {   
        ...
        280, 299, 318, 337, 356, 375, 394, 413, 432, 451,
        470, 489, 508, 527, 546, 565, 584, 603, 622, 641,
        660, 679, 698, 717, 736, 755, 774, 793, 812, 831,
        850, 869, 888, 907, 926, 945, 964, 983, 1002, 1021,
        1040, 1059, 1078, 1097, 1116, 1135, 1154, 1173, 1192, 1211,
        1230, 1249, 1268, 1287, 1306, 1325, 1344, 1363, 1382, 1736,
        1910
    };
    #elif(_PANEL_TYPE == _BOE_MV270QUM_N10_EDP_UHD)
    WORD code tBacklight_Table[101] =
    {   
		193, 226, 259, 292, 325, 358, 391, 424, 457, 490, 
		530, 571, 607, 625, 643, 661, 679, 697, 715, 
		733, 751, 769, 787, 805, 823, 841, 859, 877, 895, 
		913, 931, 949, 967, 985, 1003, 1021, 1039, 1057,1075, 
		1093, 1111, 1129, 1147, 1165, 1183, 1201, 1219, 1237,1255, 
		1273, 1291, 1309, 1327, 1345, 1363, 1381, 1399, 1417,1435, 
		1453, 1471, 1489, 1507, 1525, 1543, 1561, 1579, 1597,1615, 
		1633, 1651, 1669, 1687, 1705, 1723, 1741, 1759, 1777,1795, 
		1813, 1831, 1849, 1867, 1885, 1903, 1921, 1939, 1957,1975, 
		1993, 2011, 2029, 2047, 2065, 2083, 2101, 2119, 2137,2155, 
		2173, 2192
    };
    #elif (_PANEL_TYPE == _BOE_MV315QUM_N70_EDP_UHD_60HZ)
    WORD code tBacklight_Table[101] =
    {
        193, 231, 259, 287, 315, 343, 371, 400, 428, 456, 
		484, 512, 540, 568, 596, 624, 652, 681, 709, 737, 
		765, 793, 821, 849, 877, 905, 933, 962, 990, 1018, 
		1046, 1074, 1102, 1130, 1158, 1186, 1215, 1243, 1271, 1299, 
		1327, 1355, 1383, 1411, 1439, 1467, 1496, 1524, 1552, 1580, 
		1608, 1636, 1664, 1692, 1720, 1749, 1777, 1805, 1833, 1861, 
		1889, 1917, 1945, 1973, 2002, 2030, 2058, 2086, 2114, 2142, 
		2170, 2198, 2227, 2255, 2283, 2311, 2339, 2367, 2395, 2423, 
		2452, 2480, 2508, 2536, 2564, 2592, 2620, 2648, 2677, 2705, 
		2733, 2761, 2789, 2817, 2845, 2873, 2902, 2930, 2977, 3014, 
		3042
    };
    #else
	WORD code tBacklight_Table[101] =
    {   0, 210, 228, 245, 262, 280, 297, 314, 332, 349, 
        366, 384, 401, 418, 436, 453, 470, 488, 505, 522, 
        540, 557, 574, 592, 609, 626, 644, 661, 678, 696, 
        713, 730, 748, 765, 782, 800, 817, 834, 852, 869, 
        886, 904, 921, 938, 956, 973, 990, 1008, 1025, 1042, 
        1060, 1077, 1094, 1112, 1129, 1146, 1164, 1181, 1198, 1216, 
        1233, 1250, 1268, 1285, 1302, 1320, 1337, 1354, 1372, 1389, 
        1406, 1424, 1441, 1458, 1476, 1493, 1510, 1528, 1545, 1562, 
        1580, 1597, 1614, 1632, 1649, 1666, 1684, 1701, 1718, 1736, 
        1753, 1770, 1788, 1805, 1822, 1840, 1857, 1874, 1892, 1909, 
        1910
    };
    #endif
#else

#define tBacklight_Table_Value(x)   ( (x<_DEF_BACKLIGHT)?((DWORD)(BacklightDefault[1]-BacklightDefault[0])*x/_DEF_BACKLIGHT+BacklightDefault[0]):((DWORD)(BacklightDefault[2]-BacklightDefault[1])*(x-_DEF_BACKLIGHT)/(100-_DEF_BACKLIGHT)+BacklightDefault[1]))
#define tBacklight_Table_Value_MPRT(x)   ( (x<_DEF_BACKLIGHT)?((DWORD)(MPRTBacklightDefault[1]-MPRTBacklightDefault[0])*x/_DEF_BACKLIGHT+MPRTBacklightDefault[0]):((DWORD)(MPRTBacklightDefault[2]-MPRTBacklightDefault[1])*(x-_DEF_BACKLIGHT)/(100-_DEF_BACKLIGHT)+MPRTBacklightDefault[1]))

#endif//#if(_ADJ_BACKLIGHT_BY_TABLE==_ON)
...
// Adjust Backlight
//-------------------------------------------------------
void UserAdjustBacklight(BYTE usBacklight);
...
BYTE UserAdjustDCRCalPwm_Opposite(BYTE ucRGBValValue);
#endif
BYTE UserAdjustDCRGetPwm(void);
void UserAdjustDCRControl(bit bEn);
void UserInterfaceAdjustDCR(void);

BYTE g_ucDCR_15SEC_OffBLFlag;
BYTE g_ucDCR_TUNE_1STEP_Flag;
...
void UserAdjustBacklight(WORD usBacklight)
{
		switch(GET_OSD_COLOR_EFFECT())
		{
			...
			case _COLOREFFECT_ENERGY_SAVING :
				usBacklight = _ECO_ENERGY_SAVING_BACKLIGHT;
				break;		
#endif
		...
		if(GET_OSD_HDR_MODE() != _OFF)
		{
			if(GET_HDR10_EOTF_SETTING() == _HDR_TARGET_STATUS_SMPTE_ST_2084)
			{
				usBacklight = 100;
	...
	{
			usBacklight = tBacklight_Table_Value_MPRT(usBacklight);
	}
	else
#endif		

#if(_ADJ_BACKLIGHT_BY_TABLE==_ON)
	usBacklight = tBacklight_Table[usBacklight];
#else
	usBacklight = tBacklight_Table_Value(usBacklight);
#endif

#if(_BACKLIGHT_PWM_INVERSE == _ON)
#if(_PWM_DUT_RESOLUTION == _PWM_12BIT)
    usBacklight = 0xFFF - usBacklight;
#else
	usBacklight = 255 - usBacklight;
#endif
#endif
...
{
	OsdDispDisableOsd();
	OsdFuncApplyMap(WIDTH(8), HEIGHT(5), COLOR(_CP_BG, _CP_BG));
	OsdFontVLCLoadFont(_FONT1_GLOBAL);		
	RTDOsdTableFuncPutStringProp(1,4,_PFONT_PAGE_1,_OSD_PINLVXIANSHI_HZ,0,COLOR(_CP_RED,_CP_BG),_ENGLISH);	
...
void UserInterfaceTimerEventProc(EnumScalerTimerEventID enumEventID)
{
    switch(enumEventID)
    {
        ...
        case _USER_TIMER_EVENT_OSD_WAIT_POWER_SAVING:
            SET_OSD_EVENT_MESSAGE(_OSDEVENT_WAIT_POWER_SAVING_EVENT_MSG);
            break;

        case _USER_TIMER_EVENT_GO_TO_POWER_SAVING:
            SET_OSD_EVENT_MESSAGE(_OSDEVENT_GO_TO_POWER_SAVING_EVENT_MSG);
            break;
        case _USER_TIMER_EVENT_OSD_DISABLE_120s:
	...
	case _USER_TIMER_EVENT_FACTORY:
		CLR_KEY_HOLD();
        ...
        case _USER_TIMER_EVENT_DO_POWER_DOWN:
            CLR_KEY_HOLD();
        ...
        case _USER_TIMER_EVENT_PANEL_USED_TIMER:
		 ...
		 case _USER_TIMER_EVENT_LOCK_OSD:
            CLR_KEY_HOLD();
         	SET_OSD_LOCK((~(GET_OSD_LOCK())));
		...
		case _USER_REAL_TIME_REFRESH_RATE:
#if(_DEF_REAL_TIME_HZ)
			if(GET_OSD_HZ_DISPLAYSTATUS() != 2)
			{
				if(GET_OSD_STATE() == _MENU_NONE)
				{
					OsdHzShow();
					SET_OSD_HZ_DISPLAYSTATUS((GET_INPUT_TIMING_VFREQ()/10)|_BIT0);
				}
			}
#endif
			break;
		...
		case _USER_TIMER_EVENT_LOCK_POWER_KEY:
            if(SysModeGetModeState() == _MODE_STATUS_ACTIVE)
			{
				CLR_KEY_HOLD();
				SET_POWER_KEY_LOCK((~(GET_POWER_KEY_LOCK())));
		...
		case _USER_TIMER_EVENT_LED_MODE_FLICKER:
		...
		case _USER_TIMER_EVENT_AUTO_POWER_DOWN:
			...
			g_usPowerDownCount-=1;
			
			ScalerTimerActiveTimerEvent(SEC(60), _USER_TIMER_EVENT_AUTO_POWER_DOWN); 
		if(g_usPowerDownCount == 1)
		{
			g_usPowerDownCount_MSG=60;
	      	ScalerTimerCancelTimerEvent(_USER_TIMER_EVENT_OSD_DISABLE);// henry  20210716

			ScalerTimerActiveTimerEvent(SEC(1), _USER_TIMER_EVENT_AUTO_POWER_DOWN_MSG); 
			OsdDispOsdMessagePoweroff();
		}
		else if(g_usPowerDownCount == 0)
		{	
#if 1//
	    	SET_OSD_AUTO_POWEROFF(_DEF_POWEROFF);  
#else
			SET_OSD_AUTO_POWEROFF(_AutoPowerOff_4);
#endif
	        RTDNVRamSaveOSDData();
		...
		case _USER_TIMER_EVENT_AUTO_POWER_DOWN_MSG:
				g_usPowerDownCount_MSG--;
				ScalerTimerActiveTimerEvent(SEC(1), _USER_TIMER_EVENT_AUTO_POWER_DOWN_MSG); 
				UpdateOsdDispOsdMessagePoweroff();
				if(g_usPowerDownCount_MSG == 0)
...
#if((_FREESYNC_SUPPORT == _ON)&&(_OSD_VFREQ_CHANGE == _ON))
	case _USER_TIMER_EVENT_OSD_SHOW_DRR_VFREQ:
		OsdDisplayVfreq();
		break;
#endif
...
#if(_IR_VIRTUAL)	
BYTE tcc_time = 0,ir_up_time = 0,wave_H_count = 0,data_count = 0;
bit f_time1ms = 0,f_count_H = 0,f_guide = 0,f_resaveok = 0;
DWORD r_data = 0;
#endif
...
//ѭ��
    ...
    else
    {
        if(f_count_H==1)
        {
           ...
           if(f_guide==0)
           {  
            if(((wave_H_count>=12)&&(wave_H_count<=58)))
            {
                f_guide=1;
            }      
           ...
           {
              if(wave_H_count>=2&&wave_H_count<=9)
              {
                r_data=r_data>>1;
                r_data=r_data&0x7fffffff;        //  bit0
                data_count++;
              }
              if(wave_H_count>=10&&wave_H_count<=24)
              {
                r_data=r_data>>1;
                r_data=r_data|0x80000000;        //  bit1
                data_count++;
              }
              if(wave_H_count<=1||wave_H_count>=25)
              { 
                data_count=0; f_guide=0;
              }
               wave_H_count=0;
           }
         }
...
else if(led_start == 2)
{
	...
	{
		case 0x00:
			OSD_LED_CONTRL_SCL(LED_LOW);
			if(led_time >= 32)
			{
				led_time = 0;
				OSD_LED_CONTRL_SCL(LED_HIGH);  //�� 32ms  ===>��
				led_flag =1;
		...
		case 0x01:
			...
			{
				led_time = 0;
				OSD_LED_CONTRL_SCL(LED_LOW);// ��8 ms //��� ������====  >��
				led_flag =2;
			}		
			break;
		...
		case 0x02:
			...
			{
				led_time = 0;
				OSD_LED_CONTRL_SCL(LED_HIGH);// ��4ms===>��
				led_flag =3;
			}		
		...
		if(((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeIn)&&(GET_OSD_LED_COLOR()!=LightColorMode_Spectrum))\
			||(GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeOut))	
		{
			
				if(led_time >= 12)
				{
					led_time = 0;
					OSD_LED_CONTRL_SCL(LED_LOW);// �� 12ms	 ������� 1 ===>��
					led_flag =4;
				}	
		...
		else 
		{
					...
					{
						led_time = 0;
						OSD_LED_CONTRL_SCL(LED_LOW);// �� 4ms	������� 0 ===>��
						led_flag =4;
					}	
...
if((GET_OSD_LED_LIGHTMODE()==LightMode_Breathe)\
||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeIn)&&(GET_OSD_LED_COLOR()==LightColorMode_Spectrum))\
||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeOut)&&((GET_OSD_LED_COLOR()>=LightColorMode_Green)&&(GET_OSD_LED_COLOR()<=LightColorMode_Yellow))))
{
					if(led_time >= 12)
					{
						led_time = 0;
...
if(((GET_OSD_LED_LIGHTMODE()==LightMode_Static)&&((GET_OSD_LED_COLOR()>=LightColorMode_Blue)&&(GET_OSD_LED_COLOR()<=LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_Breathe)&&((GET_OSD_LED_COLOR()>=LightColorMode_Gyan)&&(GET_OSD_LED_COLOR()<=LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeIn)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Purple)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeOut)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Red)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow))))
...
if(((GET_OSD_LED_LIGHTMODE()==LightMode_Static)&&((GET_OSD_LED_COLOR()==LightColorMode_Red)||(GET_OSD_LED_COLOR()==LightColorMode_Green)||(GET_OSD_LED_COLOR()==LightColorMode_Purple)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_Breathe)&&((GET_OSD_LED_COLOR()==LightColorMode_Green)||(GET_OSD_LED_COLOR()==LightColorMode_Blue)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeIn)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Blue)||(GET_OSD_LED_COLOR()==LightColorMode_Gyan)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeOut)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Red)||(GET_OSD_LED_COLOR()==LightColorMode_Gyan)||(GET_OSD_LED_COLOR()==LightColorMode_Purple))))
{
...
if(((GET_OSD_LED_LIGHTMODE()==LightMode_Static)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Green)||(GET_OSD_LED_COLOR()==LightColorMode_Gyan)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_Breathe)&&((GET_OSD_LED_COLOR()==LightColorMode_Red)||(GET_OSD_LED_COLOR()==LightColorMode_Blue)||(GET_OSD_LED_COLOR()==LightColorMode_Purple)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeIn)&&((GET_OSD_LED_COLOR()==LightColorMode_Spectrum)||(GET_OSD_LED_COLOR()==LightColorMode_Green)||(GET_OSD_LED_COLOR()==LightColorMode_Gyan)||(GET_OSD_LED_COLOR()==LightColorMode_Yellow)))\
	||((GET_OSD_LED_LIGHTMODE()==LightMode_MarqueeOut)&&((GET_OSD_LED_COLOR()==LightColorMode_Red)||(GET_OSD_LED_COLOR()==LightColorMode_Blue)||(GET_OSD_LED_COLOR()==LightColorMode_Purple))))
{
...
///////////////////////////////////////////////////
		...
		{
			led_time = 0;
			OSD_LED_CONTRL_SCL(LED_HIGH);//��8ms   ��ɽ�����======>��
			led_start = 0;
			led_flag = 0;
		}		
...
void UserInterfaceUncallFunction(void)
{
	...
	OsdFontPut1BitTable_LOGO(0, 0, 0, 0 , 0);
...
#if(_INSTANT_TIMER_EVENT_1 == _ON)	//LED_EFFECT //_IR_VIRTUAL
	ScalerTimer1SetTimerCount(1);
#endif  

#if(_LED_EFFECT_TJMODE14==_ON)	//_LED_EFFECT_SC8P1152A //_IR_VIRTUAL
	if(UserCommonNVRamGetSystemData(_MONITOR_POWER_STATUS) == _OFF)
	led_start =0;
	  else
	led_start =1;
...
#if(_LED_EFFECT_TJMODE14==_ON)
                    SET_OSD_LED_LIGHTMODE(GET_OSD_LED_PRE_LIGHTMODE()); 
                    SET_OSD_LED_COLOR(GET_OSD_LED_PRE_COLOR());
                    led_start =1;
...
#if 1//
        case  _OSD_ASPECT_RATIO_USER:
            *pusHRatio = GET_INPUT_TIMING_HWIDTH();
            *pusVRatio = GET_INPUT_TIMING_VHEIGHT();
#endif
            break;
    }
}
...
BYTE UserInterfaceGetAspectRatioOriginalRatioSmall(void)
{
#if 0//(Project_ID != ID_TJZG_TMDTMD2822_HK2775E01_2P2H_UHD60HZ_20231217)
...
void UserInterfaceAdjustColorProc(void)
{
    if((GET_OSD_STATE() == _MENU_NONE) || (GET_OSD_STATE() == _MENU_FUN_RESET))
    {
...
#if 0//
		if(GET_OSD_LED_TYPE() == _OSDLedType_ON)
		{
			OSD_LED_CONTRL(_OSD_LED_ON);
	...
	//UserAdjustDCC(_OFF);//	UserAdjustDCC(_ON);  // henry by 20210802
#else
...
BYTE GetVividValue(void)
{
	if(GET_OSD_DCR_STATUS() == _OFF)
	{
		...
		{
			case _COLOREFFECT_MOVIE :
				return _ULTRA_VIVID_L;
				break;
				
			case _COLOREFFECT_GAME:
				return _ULTRA_VIVID_H;
				break;
	
			default:			
				return GET_OSD_ULTRA_VIVID_STATUS();
				break;
		}
	}
...
{
#if(_DEF_ECO_SET)
    BYTE ucUltraVividStatus = GetOsdValue(_MENU_FUN_VIVID); //GetVividValue();
#else
...
#endif
    {
        ...
        {
#if 0//
			//�ͻ���ӳ�ͱȸߵ���ɫ�������,�޸ĵ���ʹ��ͬһ��Table
			if(ucUltraVividStatus == _ULTRA_VIVID_L)
				ScalerColorUltraVividAdjust(tCOLOR_ULTRAVIVID_SETTING_TABLE[_ULTRA_VIVID_M - 1], GET_CURRENT_BANK_NUMBER());
			else
#endif
...
code BYTE *UserInterfaceGetSharpnessCoef(EnumSUCoefType enumSUCoefType, EnumSourceSearchPort enumSourceSearchPort)
{
    ...
    {
#if (_DEF_ECO_SET) || (_CUSTOMER_TYPE == _HUASHUOHUI_CUSTOMER)
		case _H_V_SU_128TAPS_NORMAL:
			return tSCALE_128TAPS_NORMAL_COEF_TABLE[GetOsdValue(_MENU_FUN_SHARPNESS)];	//GetSharpnessValue()];
		break;
		
        case _H_SU_128TAPS_1_TO_1:
            return tSCALE_128TAPS_1to1_COEF_TABLE[GetOsdValue(_MENU_FUN_SHARPNESS)];
		break;	

#if((_HSU_96TAPS_SUPPORT == _ON) || (_VSU_96TAPS_SUPPORT == _ON))
        case _H_V_SU_96TAPS_NORMAL:
            return tSCALE_96TAPS_NORMAL_COEF_TABLE[GetOsdValue(_MENU_FUN_SHARPNESS)];
#endif

#if(_HSU_96TAPS_SUPPORT == _ON)
        case _H_SU_96TAPS_1_TO_1:
            return tSCALE_96TAPS_1to1_COEF_TABLE[GetOsdValue(_MENU_FUN_SHARPNESS)];
#endif
...
{
#if(_DEF_OPPOSITE_DCR)
	if(GET_OSD_DCR_STATUS() != _OFF || GET_OSD_DCR_OPPOSITE() != _OFF)
#else
...
EnumFreeSyncSupport UserInterfaceGetFreeSyncEnable(EnumSourceSearchPort enumSourcePort)
{
    ...
    {    
#if 0
		if(GET_INPUT_TIMING_VFREQ() < 950)
		{
			if(GET_OSD_FV_INFORMATION())
				SET_OSD_FV_INFORMATION(_OFF);
...
#if(_PCB_TYPE ==_RL6463__128PIN__SG2513AR_VH_LS_R10_2__1A1H__LVDS)
				// Swap Speaker L/R Output
				ScalerSetBit(0x06E0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), 0x00);
#endif
#if(_SLEEP_AUDIO_SUPPORT == _ON)
...
#if(_PCB_TYPE == _RL6463__128PIN__SG2513AR_VH_LS_R10_2__1A1H__LVDS)
					// Swap Speaker L/R Output
					ScalerSetBit(0x06E0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4), (_BIT6 | _BIT4));
#endif
...
EnumAudioDACOutput UserInterfaceGetAudioDACOutput(void)
{
#if(_DEF_AUDIO_SOURCE_SELECT)
	if(GET_FUN_AUDIO_SOURCE())
	{
		if(GET_FUN_AUDIO_SOURCE() == 1)
...
void UserInterfaceAdjustYpeaking(void)
{
    ...
    switch(GET_OSD_ULTRA_VIVID_STATUS())
    {
        ...
        default:
            ScalerColorYpeakingAdjust(_YPEAKING_GAIN_MODE, 0, _YPEAKING_N_DIV32, _NULL_POINTER, 0x00, 0x00);
            break;
    }
#else
...
BYTE UserAdjustDCRCalPwm_Opposite(BYTE ucRGBValValue)
{
	BYTE i=0;
	BYTE ucPwm=0;
	//BYTE tRGBValValue[10] = {0,10,50,75,100,125,150,180,220,255};
#if 0//
	BYTE tRGBValValue_opp[17] = {0,15,31,46,62,77,95,110,126,146,167,173,189,205,222,237,255};
	BYTE tBacklightPwm[17] = 0;
#else
	BYTE tRGBValValue_opp[5] = {0,10,50,150,255};
	BYTE tBacklightPwm[5] = 0;
#endif


#if 0//
	if(GET_OSD_DCR_OPPOSITE() == 1) //��׼
	{
		tBacklightPwm[0] = _BACKLIGHT_MAX;	//100%
		tBacklightPwm[1] = tBacklight_Table_Value(96);
		tBacklightPwm[2] = tBacklight_Table_Value(92);
		tBacklightPwm[3] = tBacklight_Table_Value(87);
		tBacklightPwm[4] = tBacklight_Table_Value(80);
		tBacklightPwm[5] = tBacklight_Table_Value(72);
		tBacklightPwm[6] = tBacklight_Table_Value(61);
		tBacklightPwm[7] = tBacklight_Table_Value(55);
		tBacklightPwm[8] = tBacklight_Table_Value(47);
		tBacklightPwm[9] = tBacklight_Table_Value(35);
		tBacklightPwm[10] = tBacklight_Table_Value(32);
		tBacklightPwm[11] = tBacklight_Table_Value(30);
		tBacklightPwm[12] = tBacklight_Table_Value(28);
		tBacklightPwm[13] = tBacklight_Table_Value(26);
		tBacklightPwm[14] = tBacklight_Table_Value(24);
		tBacklightPwm[15] = tBacklight_Table_Value(22);
		tBacklightPwm[16] = tBacklight_Table_Value(20);
	}
	else	//0-80
	{
		tBacklightPwm[0] = _BACKLIGHT_MAX;	//100%
		...
		tBacklightPwm[2] = tBacklight_Table_Value(92);
		tBacklightPwm[3] = tBacklight_Table_Value(87);
		tBacklightPwm[4] = tBacklight_Table_Value(75);
		tBacklightPwm[5] = tBacklight_Table_Value(62);
		tBacklightPwm[6] = tBacklight_Table_Value(51);
		tBacklightPwm[7] = tBacklight_Table_Value(45);
		tBacklightPwm[8] = tBacklight_Table_Value(37);
		tBacklightPwm[9] = tBacklight_Table_Value(25);
		tBacklightPwm[10] = tBacklight_Table_Value(22);
		tBacklightPwm[11] = tBacklight_Table_Value(21);
		tBacklightPwm[12] = tBacklight_Table_Value(18);
		tBacklightPwm[13] = tBacklight_Table_Value(15);
		tBacklightPwm[14] = tBacklight_Table_Value(12);
		tBacklightPwm[15] = tBacklight_Table_Value(11);
		tBacklightPwm[16] = tBacklight_Table_Value(10);
	}
	
#elif(_DEF_BACKLIGHT  == 95)
	if(GET_OSD_DCR_OPPOSITE() == 1) //10-100
	{
		tBacklightPwm[0] = _BACKLIGHT_MAX;	//100%
		tBacklightPwm[1] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*9)+_BACKLIGHT_MIN; //90%
		tBacklightPwm[2] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*8)+_BACKLIGHT_MIN;;	//80%
		tBacklightPwm[3] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*4)+_BACKLIGHT_MIN;	//40%
		tBacklightPwm[4] = ((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)+_BACKLIGHT_MIN;	//10%
	}
	else	//0-80
	{
		tBacklightPwm[0] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*8)+_BACKLIGHT_MIN;;	//80%
		tBacklightPwm[1] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*6)+_BACKLIGHT_MIN;;	//60%
		tBacklightPwm[2] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*4)+_BACKLIGHT_MIN; //40%
		tBacklightPwm[3] = (((_BACKLIGHT_MAX-_BACKLIGHT_MIN)/10)*2)+_BACKLIGHT_MIN;	//20%
		tBacklightPwm[4] = _BACKLIGHT_MIN;	//0%
	}
	...
	{
		tBacklightPwm[0] = _BACKLIGHT_MAX;	//100%
		tBacklightPwm[1] = (_BACKLIGHT_MAX-_BACKLIGHT_DEF_PWM)/2+_BACKLIGHT_DEF_PWM; //90%
		tBacklightPwm[2] = _BACKLIGHT_DEF_PWM;	//80%
		tBacklightPwm[3] = (((_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/8)*4)+_BACKLIGHT_MIN;	//40%
		tBacklightPwm[4] = ((_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/8)+_BACKLIGHT_MIN;	//10%
	}
	else	//0-80
	{
		tBacklightPwm[0] = _BACKLIGHT_DEF_PWM;	//80%
		tBacklightPwm[1] = (((_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/8)*6)+_BACKLIGHT_MIN;	//60%
		tBacklightPwm[2] = (((_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/8)*4)+_BACKLIGHT_MIN; //40%
		tBacklightPwm[3] = (((_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/8)*2)+_BACKLIGHT_MIN;	//20%
		tBacklightPwm[4] = _BACKLIGHT_MIN;	//0%
	}
#endif
...
#if 0//
	for(i=0;i < 16;i++)	//��ȡ��ǰ��ɫֵ�׶�
	{
		if((tRGBValValue_opp[i] <= ucRGBValValue) && (ucRGBValValue <= tRGBValValue_opp[i+1]))
		{
			break;
		}
	}
...
#if 0//
	if(ucRGBValValue > 249)
	{
		i = 15;
	}
#else
	if(ucRGBValValue > 240)
	{
		i = 3;
	}
#endif
	...
	ucPwm = tBacklightPwm[i] -(WORD)(ucRGBValValue-tRGBValValue_opp[i])*(tBacklightPwm[i] - tBacklightPwm[i+1])/(tRGBValValue_opp[i+1] -tRGBValValue_opp[i]);
...
BYTE UserAdjustDCRCalPwm(BYTE ucRGBValValue)
{
	BYTE i=0;
	BYTE ucPwm=0;
	BYTE tRGBValValue[5] = {0,50,75,175,255};
	BYTE tBacklightPwm[5] = 0;

#if(_DEF_OPPOSITE_DCR)	//_MENU_FUN_DCR_OPPOSITE
	if(GET_OSD_DCR_OPPOSITE())	//DCR������
	{
		ucPwm = UserAdjustDCRCalPwm_Opposite(ucRGBValValue);
		return ucPwm;
	}
#endif
	...
	if((GET_OSD_MPRT()!=_OFF)&&(SysModeGetModeState() ==_MODE_STATUS_ACTIVE)&&(GET_INPUT_TIMING_VFREQ()> _MPRT_MIN_FRAME_RATE)&&(GET_OSD_FREE_SYNC_STATUS() == _OFF))
	{
		tBacklightPwm[0] = _MPRT_PWM_MIN;
		tBacklightPwm[1] = (_MPRT_PWM_DEF-_MPRT_PWM_MIN)/2+_MPRT_PWM_MIN;
		tBacklightPwm[2] = _MPRT_PWM_DEF;
		tBacklightPwm[3] = (_MPRT_PWM_MAX-_MPRT_PWM_DEF)/2+_MPRT_PWM_DEF;
		tBacklightPwm[4] = _MPRT_PWM_MAX;

	}
	else
	{

		tBacklightPwm[0] = _BACKLIGHT_MIN;
		tBacklightPwm[1] = (_BACKLIGHT_DEF_PWM-_BACKLIGHT_MIN)/2+_BACKLIGHT_MIN;
		tBacklightPwm[2] = _BACKLIGHT_DEF_PWM;
		tBacklightPwm[3] = (_BACKLIGHT_MAX-_BACKLIGHT_DEF_PWM)/2+_BACKLIGHT_DEF_PWM;
		tBacklightPwm[4] = _BACKLIGHT_MAX;
...
BYTE UserAdjustDCRGetPwm(void)
{
	...
	DebugMessageOsd("0.ucMeasureValueAvg",ucMeasureValueAvg);
	DebugMessageOsd("0.ucMeasureHighR",ucMeasureHighR);
#else
	...
	DebugMessageOsd("1.ucMeasureValueAvg",ucMeasureValueAvg);
	DebugMessageOsd("1.ucMeasureHighR",ucMeasureHighR);
#endif
	...
	if(bBACKLIGHTPOWER == _LIGHT_CONTROL_ON)
	{
		...
		{
#if(_DCR_PANEL_ON_OFF)
			ScalerTimerActiveTimerEvent(SEC(15),_USER_TIMER_EVENT_DCR_CAL_TIME);
#else
...
#if(_DCR_PANEL_ON_OFF == _ON)
	    	PCB_BACKLIGHT_POWER(_LIGHT_CONTROL_ON);
			DebugMessageOsd("1.dcr turn on backlight",1);
#endif
		}
...
DebugMessageSystem("ucPrePwm",ucPrePwm);
DebugMessageSystem("uctargetPwm",uctargetPwm);
...
void UserAdjustLowMotionBlurDisplay(BYTE ucTconLevel)
{
	//WORD g_MPRTValue_i;	

    if((ucTconLevel !=_OFF)&&(SysModeGetModeState() ==_MODE_STATUS_ACTIVE)&&(GET_INPUT_TIMING_VFREQ()> _MPRT_MIN_FRAME_RATE)&&(GET_OSD_FREE_SYNC_STATUS() == _OFF))
    {
		...
		if(ucTconLevel==1)
			g_MPRTValue = (DWORD)(GET_MDOMAIN_OUTPUT_VBSTART() + GET_MDOMAIN_OUTPUT_VBHEIGHT())*_MPRT_RATIO/100;	   
		else if(ucTconLevel==2)
			g_MPRTValue = (DWORD)(GET_MDOMAIN_OUTPUT_VBSTART() + GET_MDOMAIN_OUTPUT_VBHEIGHT())*_MPRT_MID_RATIO/100;	   
		else if(ucTconLevel==3)
			g_MPRTValue = (DWORD)(GET_MDOMAIN_OUTPUT_VBSTART() + GET_MDOMAIN_OUTPUT_VBHEIGHT())*_MPRT_HIGH_RATIO/100;	   
#else
		g_MPRTValue = (DWORD)(GET_MDOMAIN_OUTPUT_VBSTART() + GET_MDOMAIN_OUTPUT_VBHEIGHT())*_MPRT_RATIO/100;	   
#endif
