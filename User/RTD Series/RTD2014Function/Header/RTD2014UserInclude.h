...
extern BYTE UserAdjustDCRCalPwm_Opposite(BYTE ucRGBValValue);
#endif
...
typedef enum
{
	...
	_FLASH_ITEMID_OSD_DATA_2, // 6 
    _FLASH_ITEMID_OSD_DATA_END = _FLASH_ITEMID_OSD_DATA_2,
    _FLASH_ITEMID_BRICON_SRC0_VGA,// 7
   // _FLASH_ITEMID_BRICON_SRC1_VIDEO,
   // _FLASH_ITEMID_BRICON_SRC2_DVI,
  //  _FLASH_ITEMID_BRICON_SRC3_HDMI,
 //   _FLASH_ITEMID_BRICON_SRC4_DP, 
    _FLASH_ITEMID_COLORPROC0_9300,// 8
    _FLASH_ITEMID_COLORPROC1_7500,// 9
    _FLASH_ITEMID_COLORPROC2_6500,// 10
    _FLASH_ITEMID_COLORPROC3_5800,// 11
    _FLASH_ITEMID_COLORPROC4_SRGB, // 12
    _FLASH_ITEMID_COLORPROC5_USER,// 13
#if(_DEF_CT_JX)
	_FLASH_ITEMID_COLORPROC6_7000,//14
	_FLASH_ITEMID_COLORPROC3_8000,//
	_FLASH_ITEMID_COLORPROC3_GAMMA18,
	_FLASH_ITEMID_COLORPROC3_GAMMA20,
	_FLASH_ITEMID_COLORPROC3_GAMMA22,
	_FLASH_ITEMID_COLORPROC3_GAMMA24,
	_FLASH_ITEMID_COLORPROC3_GAMMA26,//20
#endif
...
enum
{
	_HDR_INPUTGAMMA_1200 = 3,
	_HDR_INPUTGAMMA_1200_DARK,

	_HDR_INPUTGAMMA_4000,
	_HDR_INPUTGAMMA_4000_DARK,

	_HDR_INPUTGAMMA_10000,
	_HDR_INPUTGAMMA_10000_DARK,

	_HDR_INPUTGAMMA_540,
	_HDR_INPUTGAMMA_540_DARK,
...
// Adjust Backlight
//-------------------------------------------------------
extern void UserAdjustBacklight(BYTE usBacklight);
...
extern void UserAdjustContrast(BYTE usContrast);
#endif
